...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	0b250513          	addi	a0,a0,178 # 60f0 <malloc+0x448>
      46:	00006097          	auipc	ra,0x6
      4a:	ba4080e7          	jalr	-1116(ra) # 5bea <printf>
      exit(1);
      4e:	4505                	li	a0,1
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
      ...
      5c:	64878793          	addi	a5,a5,1608 # 96a0 <uninit>
      60:	0000c697          	auipc	a3,0xc
      64:	d5068693          	addi	a3,a3,-688 # bdb0 <buf>
    if(uninit[i] != '\0'){
      ...
      74:	8082                	ret
{
      ...
      84:	09050513          	addi	a0,a0,144 # 6110 <malloc+0x468>
      88:	00006097          	auipc	ra,0x6
      8c:	b62080e7          	jalr	-1182(ra) # 5bea <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	08050513          	addi	a0,a0,128 # 6128 <malloc+0x480>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	08250513          	addi	a0,a0,130 # 6148 <malloc+0x4a0>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	04a50513          	addi	a0,a0,74 # 6130 <malloc+0x488>
      ee:	00006097          	auipc	ra,0x6
      f2:	afc080e7          	jalr	-1284(ra) # 5bea <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	05650513          	addi	a0,a0,86 # 6158 <malloc+0x4b0>
     10a:	00006097          	auipc	ra,0x6
     10e:	ae0080e7          	jalr	-1312(ra) # 5bea <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	05450513          	addi	a0,a0,84 # 6180 <malloc+0x4d8>
     134:	00005097          	auipc	ra,0x5
     138:	76e080e7          	jalr	1902(ra) # 58a2 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	04050513          	addi	a0,a0,64 # 6180 <malloc+0x4d8>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	03c58593          	addi	a1,a1,60 # 6190 <malloc+0x4e8>
     15c:	00005097          	auipc	ra,0x5
     160:	716080e7          	jalr	1814(ra) # 5872 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	01850513          	addi	a0,a0,24 # 6180 <malloc+0x4d8>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	01c58593          	addi	a1,a1,28 # 6198 <malloc+0x4f0>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	fec50513          	addi	a0,a0,-20 # 6180 <malloc+0x4d8>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	fd650513          	addi	a0,a0,-42 # 61a0 <malloc+0x4f8>
     1d2:	00006097          	auipc	ra,0x6
     1d6:	a18080e7          	jalr	-1512(ra) # 5bea <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	cf450513          	addi	a0,a0,-780 # 5f70 <malloc+0x2c8>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	ce0a8a93          	addi	s5,s5,-800 # 5f70 <malloc+0x2c8>
      int cc = write(fd, buf, sz);
     298:	0000ca17          	auipc	s4,0xc
     29c:	b18a0a13          	addi	s4,s4,-1256 # bdb0 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2a0:	6b0d                	lui	s6,0x3
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	eb650513          	addi	a0,a0,-330 # 61c8 <malloc+0x520>
     31a:	00006097          	auipc	ra,0x6
     31e:	8d0080e7          	jalr	-1840(ra) # 5bea <printf>
      exit(1);
     322:	4505                	li	a0,1
     ...
     33a:	eb250513          	addi	a0,a0,-334 # 61e8 <malloc+0x540>
     33e:	00006097          	auipc	ra,0x6
     342:	8ac080e7          	jalr	-1876(ra) # 5bea <printf>
        exit(1);
     346:	4505                	li	a0,1
...
0000000000000350 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     376:	e8ea0a13          	addi	s4,s4,-370 # 6200 <malloc+0x558>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     422:	dea50513          	addi	a0,a0,-534 # 6208 <malloc+0x560>
     426:	00005097          	auipc	ra,0x5
     42a:	7c4080e7          	jalr	1988(ra) # 5bea <printf>
      exit(1);
     42e:	4505                	li	a0,1
     ...
     440:	de450513          	addi	a0,a0,-540 # 6220 <malloc+0x578>
     444:	00005097          	auipc	ra,0x5
     448:	7a6080e7          	jalr	1958(ra) # 5bea <printf>
      exit(1);
     44c:	4505                	li	a0,1
     ...
     45e:	df650513          	addi	a0,a0,-522 # 6250 <malloc+0x5a8>
     462:	00005097          	auipc	ra,0x5
     466:	788080e7          	jalr	1928(ra) # 5bea <printf>
      exit(1);
     46a:	4505                	li	a0,1
     ...
     478:	e0c50513          	addi	a0,a0,-500 # 6280 <malloc+0x5d8>
     47c:	00005097          	auipc	ra,0x5
     480:	76e080e7          	jalr	1902(ra) # 5bea <printf>
      exit(1);
     484:	4505                	li	a0,1
     ...
     496:	dfe50513          	addi	a0,a0,-514 # 6290 <malloc+0x5e8>
     49a:	00005097          	auipc	ra,0x5
     49e:	750080e7          	jalr	1872(ra) # 5bea <printf>
      exit(1);
     4a2:	4505                	li	a0,1
...
00000000000004ac <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d4:	df0a0a13          	addi	s4,s4,-528 # 62c0 <malloc+0x618>
    n = write(fds[1], "x", 1);
     4d8:	00006a97          	auipc	s5,0x6
     4dc:	cc0a8a93          	addi	s5,s5,-832 # 6198 <malloc+0x4f0>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     582:	d4a50513          	addi	a0,a0,-694 # 62c8 <malloc+0x620>
     586:	00005097          	auipc	ra,0x5
     58a:	664080e7          	jalr	1636(ra) # 5bea <printf>
      exit(1);
     58e:	4505                	li	a0,1
     ...
     5a0:	d4450513          	addi	a0,a0,-700 # 62e0 <malloc+0x638>
     5a4:	00005097          	auipc	ra,0x5
     5a8:	646080e7          	jalr	1606(ra) # 5bea <printf>
      exit(1);
     5ac:	4505                	li	a0,1
     ...
     5ba:	cca50513          	addi	a0,a0,-822 # 6280 <malloc+0x5d8>
     5be:	00005097          	auipc	ra,0x5
     5c2:	62c080e7          	jalr	1580(ra) # 5bea <printf>
      exit(1);
     5c6:	4505                	li	a0,1
     ...
     5d4:	d4050513          	addi	a0,a0,-704 # 6310 <malloc+0x668>
     5d8:	00005097          	auipc	ra,0x5
     5dc:	612080e7          	jalr	1554(ra) # 5bea <printf>
      exit(1);
     5e0:	4505                	li	a0,1
     ...
     5f2:	d3a50513          	addi	a0,a0,-710 # 6328 <malloc+0x680>
     5f6:	00005097          	auipc	ra,0x5
     5fa:	5f4080e7          	jalr	1524(ra) # 5bea <printf>
      exit(1);
     5fe:	4505                	li	a0,1
...
0000000000000608 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     648:	b4c58593          	addi	a1,a1,-1204 # 6190 <malloc+0x4e8>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     664:	b2050513          	addi	a0,a0,-1248 # 6180 <malloc+0x4d8>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     690:	af450513          	addi	a0,a0,-1292 # 6180 <malloc+0x4d8>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a4:	ae050513          	addi	a0,a0,-1312 # 6180 <malloc+0x4d8>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e2:	cda58593          	addi	a1,a1,-806 # 63b8 <malloc+0x710>
     6e6:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     724:	a6050513          	addi	a0,a0,-1440 # 6180 <malloc+0x4d8>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     768:	bf450513          	addi	a0,a0,-1036 # 6358 <malloc+0x6b0>
     76c:	00005097          	auipc	ra,0x5
     770:	47e080e7          	jalr	1150(ra) # 5bea <printf>
    exit(1);
     774:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     784:	bf850513          	addi	a0,a0,-1032 # 6378 <malloc+0x6d0>
     788:	00005097          	auipc	ra,0x5
     78c:	462080e7          	jalr	1122(ra) # 5bea <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     790:	8652                	mv	a2,s4
     792:	85d6                	mv	a1,s5
     794:	00006517          	auipc	a0,0x6
     798:	bf450513          	addi	a0,a0,-1036 # 6388 <malloc+0x6e0>
     79c:	00005097          	auipc	ra,0x5
     7a0:	44e080e7          	jalr	1102(ra) # 5bea <printf>
    exit(1);
     7a4:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b4:	bf850513          	addi	a0,a0,-1032 # 63a8 <malloc+0x700>
     7b8:	00005097          	auipc	ra,0x5
     7bc:	432080e7          	jalr	1074(ra) # 5bea <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7c0:	8652                	mv	a2,s4
     7c2:	85d6                	mv	a1,s5
     7c4:	00006517          	auipc	a0,0x6
     7c8:	bc450513          	addi	a0,a0,-1084 # 6388 <malloc+0x6e0>
     7cc:	00005097          	auipc	ra,0x5
     7d0:	41e080e7          	jalr	1054(ra) # 5bea <printf>
    exit(1);
     7d4:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e6:	bde50513          	addi	a0,a0,-1058 # 63c0 <malloc+0x718>
     7ea:	00005097          	auipc	ra,0x5
     7ee:	400080e7          	jalr	1024(ra) # 5bea <printf>
    exit(1);
     7f2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     804:	be050513          	addi	a0,a0,-1056 # 63e0 <malloc+0x738>
     808:	00005097          	auipc	ra,0x5
     80c:	3e2080e7          	jalr	994(ra) # 5bea <printf>
    exit(1);
     810:	4505                	li	a0,1
...
000000000000081a <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     838:	bcc50513          	addi	a0,a0,-1076 # 6400 <malloc+0x758>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     850:	bdc98993          	addi	s3,s3,-1060 # 6428 <malloc+0x780>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     854:	00006a97          	auipc	s5,0x6
     858:	c0ca8a93          	addi	s5,s5,-1012 # 6460 <malloc+0x7b8>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89e:	b6650513          	addi	a0,a0,-1178 # 6400 <malloc+0x758>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8b8:	4fc58593          	addi	a1,a1,1276 # bdb0 <buf>
  ...
  if(unlink("small") < 0){
     ...
     8da:	b2a50513          	addi	a0,a0,-1238 # 6400 <malloc+0x758>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     904:	b0850513          	addi	a0,a0,-1272 # 6408 <malloc+0x760>
     908:	00005097          	auipc	ra,0x5
     90c:	2e2080e7          	jalr	738(ra) # 5bea <printf>
    exit(1);
     910:	4505                	li	a0,1
     ...
     922:	b1a50513          	addi	a0,a0,-1254 # 6438 <malloc+0x790>
     926:	00005097          	auipc	ra,0x5
     92a:	2c4080e7          	jalr	708(ra) # 5bea <printf>
      exit(1);
     92e:	4505                	li	a0,1
     ...
     940:	b3450513          	addi	a0,a0,-1228 # 6470 <malloc+0x7c8>
     944:	00005097          	auipc	ra,0x5
     948:	2a6080e7          	jalr	678(ra) # 5bea <printf>
      exit(1);
     94c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95c:	b4050513          	addi	a0,a0,-1216 # 6498 <malloc+0x7f0>
     960:	00005097          	auipc	ra,0x5
     964:	28a080e7          	jalr	650(ra) # 5bea <printf>
    exit(1);
     968:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     978:	b4450513          	addi	a0,a0,-1212 # 64b8 <malloc+0x810>
     97c:	00005097          	auipc	ra,0x5
     980:	26e080e7          	jalr	622(ra) # 5bea <printf>
    exit(1);
     984:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     994:	b4050513          	addi	a0,a0,-1216 # 64d0 <malloc+0x828>
     998:	00005097          	auipc	ra,0x5
     99c:	252080e7          	jalr	594(ra) # 5bea <printf>
    exit(1);
     9a0:	4505                	li	a0,1
...
00000000000009aa <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c6:	b2e50513          	addi	a0,a0,-1234 # 64f0 <malloc+0x848>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9da:	3da90913          	addi	s2,s2,986 # bdb0 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     a18:	adc50513          	addi	a0,a0,-1316 # 64f0 <malloc+0x848>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a2c:	38890913          	addi	s2,s2,904 # bdb0 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	a9c50513          	addi	a0,a0,-1380 # 64f8 <malloc+0x850>
     a64:	00005097          	auipc	ra,0x5
     a68:	186080e7          	jalr	390(ra) # 5bea <printf>
    exit(1);
     a6c:	4505                	li	a0,1
     ...
     a7e:	a9e50513          	addi	a0,a0,-1378 # 6518 <malloc+0x870>
     a82:	00005097          	auipc	ra,0x5
     a86:	168080e7          	jalr	360(ra) # 5bea <printf>
      exit(1);
     a8a:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a9a:	aaa50513          	addi	a0,a0,-1366 # 6540 <malloc+0x898>
     a9e:	00005097          	auipc	ra,0x5
     aa2:	14c080e7          	jalr	332(ra) # 5bea <printf>
    exit(1);
     aa6:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ac6:	a2e50513          	addi	a0,a0,-1490 # 64f0 <malloc+0x848>
     ...
     af2:	a7250513          	addi	a0,a0,-1422 # 6560 <malloc+0x8b8>
     af6:	00005097          	auipc	ra,0x5
     afa:	0f4080e7          	jalr	244(ra) # 5bea <printf>
        exit(1);
     afe:	4505                	li	a0,1
     ...
     b10:	a7c50513          	addi	a0,a0,-1412 # 6588 <malloc+0x8e0>
     b14:	00005097          	auipc	ra,0x5
     b18:	0d6080e7          	jalr	214(ra) # 5bea <printf>
      exit(1);
     b1c:	4505                	li	a0,1
     ...
     b2e:	a7650513          	addi	a0,a0,-1418 # 65a0 <malloc+0x8f8>
     b32:	00005097          	auipc	ra,0x5
     b36:	0b8080e7          	jalr	184(ra) # 5bea <printf>
      exit(1);
     b3a:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b4a:	a8250513          	addi	a0,a0,-1406 # 65c8 <malloc+0x920>
     b4e:	00005097          	auipc	ra,0x5
     b52:	09c080e7          	jalr	156(ra) # 5bea <printf>
    exit(1);
     b56:	4505                	li	a0,1
...
0000000000000b60 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b78:	38c50513          	addi	a0,a0,908 # 5f00 <malloc+0x258>
  ...
  write(fd, "hello", SZ);
     ...
     b90:	a7458593          	addi	a1,a1,-1420 # 6600 <malloc+0x958>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bac:	35850513          	addi	a0,a0,856 # 5f00 <malloc+0x258>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc2:	34250513          	addi	a0,a0,834 # 5f00 <malloc+0x258>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd8:	32c50513          	addi	a0,a0,812 # 5f00 <malloc+0x258>
  ...
  write(fd1, "yyy", 3);
     ...
     bec:	a6058593          	addi	a1,a1,-1440 # 6648 <malloc+0x9a0>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c08:	1ac58593          	addi	a1,a1,428 # bdb0 <buf>
     c0c:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c54:	2b050513          	addi	a0,a0,688 # 5f00 <malloc+0x258>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c74:	97050513          	addi	a0,a0,-1680 # 65e0 <malloc+0x938>
     c78:	00005097          	auipc	ra,0x5
     c7c:	f72080e7          	jalr	-142(ra) # 5bea <printf>
    exit(1);
     c80:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c90:	97c50513          	addi	a0,a0,-1668 # 6608 <malloc+0x960>
     c94:	00005097          	auipc	ra,0x5
     c98:	f56080e7          	jalr	-170(ra) # 5bea <printf>
    exit(1);
     c9c:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     cac:	98050513          	addi	a0,a0,-1664 # 6628 <malloc+0x980>
     cb0:	00005097          	auipc	ra,0x5
     cb4:	f3a080e7          	jalr	-198(ra) # 5bea <printf>
    exit(1);
     cb8:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc8:	98c50513          	addi	a0,a0,-1652 # 6650 <malloc+0x9a8>
     ccc:	00005097          	auipc	ra,0x5
     cd0:	f1e080e7          	jalr	-226(ra) # 5bea <printf>
    exit(1);
     cd4:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce4:	99050513          	addi	a0,a0,-1648 # 6670 <malloc+0x9c8>
     ce8:	00005097          	auipc	ra,0x5
     cec:	f02080e7          	jalr	-254(ra) # 5bea <printf>
    exit(1);
     cf0:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     d00:	99450513          	addi	a0,a0,-1644 # 6690 <malloc+0x9e8>
     d04:	00005097          	auipc	ra,0x5
     d08:	ee6080e7          	jalr	-282(ra) # 5bea <printf>
    exit(1);
     d0c:	4505                	li	a0,1
...
0000000000000d16 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d64:	8a058593          	addi	a1,a1,-1888 # 6600 <malloc+0x958>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d84:	93858593          	addi	a1,a1,-1736 # 66b8 <malloc+0xa10>
     d88:	00006517          	auipc	a0,0x6
     d8c:	92850513          	addi	a0,a0,-1752 # 66b0 <malloc+0xa08>
  ...
  unlink("lf1");
     ...
     da0:	91450513          	addi	a0,a0,-1772 # 66b0 <malloc+0xa08>
     da4:	00005097          	auipc	ra,0x5
     da8:	afe080e7          	jalr	-1282(ra) # 58a2 <unlink>
  if(open("lf1", 0) >= 0){
     dac:	4581                	li	a1,0
     dae:	00006517          	auipc	a0,0x6
     db2:	90250513          	addi	a0,a0,-1790 # 66b0 <malloc+0xa08>
  ...
  fd = open("lf2", 0);
     ...
     dc8:	8f450513          	addi	a0,a0,-1804 # 66b8 <malloc+0xa10>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     de0:	fd458593          	addi	a1,a1,-44 # bdb0 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     e00:	8bc58593          	addi	a1,a1,-1860 # 66b8 <malloc+0xa10>
     e04:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e16:	8a650513          	addi	a0,a0,-1882 # 66b8 <malloc+0xa10>
     e1a:	00005097          	auipc	ra,0x5
     e1e:	a88080e7          	jalr	-1400(ra) # 58a2 <unlink>
  if(link("lf2", "lf1") >= 0){
     e22:	00006597          	auipc	a1,0x6
     e26:	88e58593          	addi	a1,a1,-1906 # 66b0 <malloc+0xa08>
     e2a:	00006517          	auipc	a0,0x6
     e2e:	88e50513          	addi	a0,a0,-1906 # 66b8 <malloc+0xa10>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e42:	87258593          	addi	a1,a1,-1934 # 66b0 <malloc+0xa08>
     e46:	00006517          	auipc	a0,0x6
     e4a:	97a50513          	addi	a0,a0,-1670 # 67c0 <malloc+0xb18>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6c:	85850513          	addi	a0,a0,-1960 # 66c0 <malloc+0xa18>
     e70:	00005097          	auipc	ra,0x5
     e74:	d7a080e7          	jalr	-646(ra) # 5bea <printf>
    exit(1);
     e78:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e88:	85450513          	addi	a0,a0,-1964 # 66d8 <malloc+0xa30>
     e8c:	00005097          	auipc	ra,0x5
     e90:	d5e080e7          	jalr	-674(ra) # 5bea <printf>
    exit(1);
     e94:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea4:	85050513          	addi	a0,a0,-1968 # 66f0 <malloc+0xa48>
     ea8:	00005097          	auipc	ra,0x5
     eac:	d42080e7          	jalr	-702(ra) # 5bea <printf>
    exit(1);
     eb0:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ec0:	85450513          	addi	a0,a0,-1964 # 6710 <malloc+0xa68>
     ec4:	00005097          	auipc	ra,0x5
     ec8:	d26080e7          	jalr	-730(ra) # 5bea <printf>
    exit(1);
     ecc:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     edc:	86850513          	addi	a0,a0,-1944 # 6740 <malloc+0xa98>
     ee0:	00005097          	auipc	ra,0x5
     ee4:	d0a080e7          	jalr	-758(ra) # 5bea <printf>
    exit(1);
     ee8:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef8:	86450513          	addi	a0,a0,-1948 # 6758 <malloc+0xab0>
     efc:	00005097          	auipc	ra,0x5
     f00:	cee080e7          	jalr	-786(ra) # 5bea <printf>
    exit(1);
     f04:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f14:	86050513          	addi	a0,a0,-1952 # 6770 <malloc+0xac8>
     f18:	00005097          	auipc	ra,0x5
     f1c:	cd2080e7          	jalr	-814(ra) # 5bea <printf>
    exit(1);
     f20:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     f30:	86c50513          	addi	a0,a0,-1940 # 6798 <malloc+0xaf0>
     f34:	00005097          	auipc	ra,0x5
     f38:	cb6080e7          	jalr	-842(ra) # 5bea <printf>
    exit(1);
     f3c:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4c:	88050513          	addi	a0,a0,-1920 # 67c8 <malloc+0xb20>
     f50:	00005097          	auipc	ra,0x5
     f54:	c9a080e7          	jalr	-870(ra) # 5bea <printf>
    exit(1);
     f58:	4505                	li	a0,1
...
0000000000000f62 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb2:	83aa0a13          	addi	s4,s4,-1990 # 67e8 <malloc+0xb40>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1004:	7e850513          	addi	a0,a0,2024 # 67e8 <malloc+0xb40>
  ...
  for(i = 0; i < N; i++){
    ...
    1074:	78050513          	addi	a0,a0,1920 # 67f0 <malloc+0xb48>
    1078:	00005097          	auipc	ra,0x5
    107c:	b72080e7          	jalr	-1166(ra) # 5bea <printf>
    exit(1);
    1080:	4505                	li	a0,1
    ...
    1094:	78050513          	addi	a0,a0,1920 # 6810 <malloc+0xb68>
    1098:	00005097          	auipc	ra,0x5
    109c:	b52080e7          	jalr	-1198(ra) # 5bea <printf>
      exit(1);
    10a0:	4505                	li	a0,1
    ...
    10b0:	78450513          	addi	a0,a0,1924 # 6830 <malloc+0xb88>
    10b4:	00005097          	auipc	ra,0x5
    10b8:	b36080e7          	jalr	-1226(ra) # 5bea <printf>
      exit(1);
    10bc:	4505                	li	a0,1
...
00000000000010c6 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e2:	77298993          	addi	s3,s3,1906 # 6850 <malloc+0xba8>
    10e6:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111e:	74650513          	addi	a0,a0,1862 # 6860 <malloc+0xbb8>
    1122:	00005097          	auipc	ra,0x5
    1126:	ac8080e7          	jalr	-1336(ra) # 5bea <printf>
      exit(1);
    112a:	4505                	li	a0,1
...
badarg(char *s)
{
    ...
    117c:	35048493          	addi	s1,s1,848 # c350 <buf+0x5a0>
  for(int i = 0; i < 50000; i++){
    ...
    118a:	fa298993          	addi	s3,s3,-94 # 6128 <malloc+0x480>
    argv[0] = (char*)0xffffffff;
...
00000000000011b2 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1214:	83878793          	addi	a5,a5,-1992 # 7a48 <malloc+0x1da0>
  ...
  if(pid == 0){
    ...
    124a:	45278793          	addi	a5,a5,1106 # 8698 <big.1278>
    124e:	00008697          	auipc	a3,0x8
    1252:	44a68693          	addi	a3,a3,1098 # 9698 <__global_pointer$+0x910>
      big[i] = 'x';
    ...
    1268:	42078a23          	sb	zero,1076(a5) # 9698 <__global_pointer$+0x910>
    char *args2[] = { big, big, big, 0 };
    126c:	00007797          	auipc	a5,0x7
    1270:	eec78793          	addi	a5,a5,-276 # 8158 <malloc+0x24b0>
    ...
    1294:	e9850513          	addi	a0,a0,-360 # 6128 <malloc+0x480>
    ...
    12ac:	66050513          	addi	a0,a0,1632 # 6908 <malloc+0xc60>
    12b0:	00005097          	auipc	ra,0x5
    12b4:	93a080e7          	jalr	-1734(ra) # 5bea <printf>
      exit(1);
    12b8:	4505                	li	a0,1
    ...
    12cc:	5b850513          	addi	a0,a0,1464 # 6880 <malloc+0xbd8>
    12d0:	00005097          	auipc	ra,0x5
    12d4:	91a080e7          	jalr	-1766(ra) # 5bea <printf>
    exit(1);
    12d8:	4505                	li	a0,1
    ...
    12ec:	5b850513          	addi	a0,a0,1464 # 68a0 <malloc+0xbf8>
    12f0:	00005097          	auipc	ra,0x5
    12f4:	8fa080e7          	jalr	-1798(ra) # 5bea <printf>
    exit(1);
    12f8:	4505                	li	a0,1
    ...
    130e:	5b650513          	addi	a0,a0,1462 # 68c0 <malloc+0xc18>
    1312:	00005097          	auipc	ra,0x5
    1316:	8d8080e7          	jalr	-1832(ra) # 5bea <printf>
    exit(1);
    131a:	4505                	li	a0,1
    ...
    132e:	5be50513          	addi	a0,a0,1470 # 68e8 <malloc+0xc40>
    1332:	00005097          	auipc	ra,0x5
    1336:	8b8080e7          	jalr	-1864(ra) # 5bea <printf>
    exit(1);
    133a:	4505                	li	a0,1
    ...
    1348:	a3c50513          	addi	a0,a0,-1476 # 6d80 <malloc+0x10d8>
    134c:	00005097          	auipc	ra,0x5
    1350:	89e080e7          	jalr	-1890(ra) # 5bea <printf>
    exit(1);
    1354:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1392:	5a250513          	addi	a0,a0,1442 # 6930 <malloc+0xc88>
    1396:	00005097          	auipc	ra,0x5
    139a:	854080e7          	jalr	-1964(ra) # 5bea <printf>
    exit(1);
    139e:	4505                	li	a0,1
...
00000000000013a8 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c4:	dc050513          	addi	a0,a0,-576 # 6180 <malloc+0x4d8>
  ...
  if(pid == 0){
    ...
    13ee:	d96a0a13          	addi	s4,s4,-618 # 6180 <malloc+0x4d8>
      int n = write(fd, "1234567890", 10);
    13f2:	00005a97          	auipc	s5,0x5
    13f6:	59ea8a93          	addi	s5,s5,1438 # 6990 <malloc+0xce8>
      int fd = open("truncfile", O_WRONLY);
    13fa:	4585                	li	a1,1
    13fc:	8552                	mv	a0,s4
    ...
    1466:	4fe50513          	addi	a0,a0,1278 # 6960 <malloc+0xcb8>
    146a:	00004097          	auipc	ra,0x4
    146e:	780080e7          	jalr	1920(ra) # 5bea <printf>
    exit(1);
    1472:	4505                	li	a0,1
    ...
    1482:	4fa50513          	addi	a0,a0,1274 # 6978 <malloc+0xcd0>
    1486:	00004097          	auipc	ra,0x4
    148a:	764080e7          	jalr	1892(ra) # 5bea <printf>
        exit(1);
    148e:	4505                	li	a0,1
    ...
    14a0:	50450513          	addi	a0,a0,1284 # 69a0 <malloc+0xcf8>
    14a4:	00004097          	auipc	ra,0x4
    14a8:	746080e7          	jalr	1862(ra) # 5bea <printf>
        exit(1);
    14ac:	4505                	li	a0,1
    ...
    14be:	cc6a0a13          	addi	s4,s4,-826 # 6180 <malloc+0x4d8>
    int n = write(fd, "xxx", 3);
    14c2:	00005a97          	auipc	s5,0x5
    14c6:	4fea8a93          	addi	s5,s5,1278 # 69c0 <malloc+0xd18>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1510:	c7450513          	addi	a0,a0,-908 # 6180 <malloc+0x4d8>
  ...
  exit(xstatus);
    ...
    152e:	44e50513          	addi	a0,a0,1102 # 6978 <malloc+0xcd0>
    1532:	00004097          	auipc	ra,0x4
    1536:	6b8080e7          	jalr	1720(ra) # 5bea <printf>
      exit(1);
    153a:	4505                	li	a0,1
    ...
    154c:	48050513          	addi	a0,a0,1152 # 69c8 <malloc+0xd20>
    1550:	00004097          	auipc	ra,0x4
    1554:	69a080e7          	jalr	1690(ra) # 5bea <printf>
      exit(1);
    1558:	4505                	li	a0,1
...
0000000000001562 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1574:	bb878793          	addi	a5,a5,-1096 # 6128 <malloc+0x480>
    1578:	fcf43023          	sd	a5,-64(s0)
    157c:	00005797          	auipc	a5,0x5
    1580:	46c78793          	addi	a5,a5,1132 # 69e8 <malloc+0xd40>
    1584:	fcf43423          	sd	a5,-56(s0)
    1588:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    158c:	00005517          	auipc	a0,0x5
    1590:	46450513          	addi	a0,a0,1124 # 69f0 <malloc+0xd48>
  ...
  if(pid == 0) {
    ...
    15be:	43650513          	addi	a0,a0,1078 # 69f0 <malloc+0xd48>
    ...
    15da:	43a50513          	addi	a0,a0,1082 # 6a10 <malloc+0xd68>
    15de:	00004097          	auipc	ra,0x4
    15e2:	60c080e7          	jalr	1548(ra) # 5bea <printf>
      exit(1);
    15e6:	4505                	li	a0,1
    ...
    15f6:	36e50513          	addi	a0,a0,878 # 6960 <malloc+0xcb8>
    15fa:	00004097          	auipc	ra,0x4
    15fe:	5f0080e7          	jalr	1520(ra) # 5bea <printf>
     exit(1);
    1602:	4505                	li	a0,1
    ...
    1612:	3ea50513          	addi	a0,a0,1002 # 69f8 <malloc+0xd50>
    1616:	00004097          	auipc	ra,0x4
    161a:	5d4080e7          	jalr	1492(ra) # 5bea <printf>
      exit(1);
    161e:	4505                	li	a0,1
    ...
    1630:	afc50513          	addi	a0,a0,-1284 # 6128 <malloc+0x480>
  ...
  if(xstatus != 0)
    ...
    1664:	3c050513          	addi	a0,a0,960 # 6a20 <malloc+0xd78>
    1668:	00004097          	auipc	ra,0x4
    166c:	582080e7          	jalr	1410(ra) # 5bea <printf>
      exit(1);
    1670:	4505                	li	a0,1
    ...
    1680:	3bc50513          	addi	a0,a0,956 # 6a38 <malloc+0xd90>
    1684:	00004097          	auipc	ra,0x4
    1688:	566080e7          	jalr	1382(ra) # 5bea <printf>
    168c:	b7d1                	j	1650 <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    168e:	4581                	li	a1,0
    1690:	00005517          	auipc	a0,0x5
    1694:	36050513          	addi	a0,a0,864 # 69f0 <malloc+0xd48>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16be:	dfe50513          	addi	a0,a0,-514 # 64b8 <malloc+0x810>
    16c2:	00004097          	auipc	ra,0x4
    16c6:	528080e7          	jalr	1320(ra) # 5bea <printf>
    exit(1);
    16ca:	4505                	li	a0,1
    ...
    16da:	2a250513          	addi	a0,a0,674 # 6978 <malloc+0xcd0>
    16de:	00004097          	auipc	ra,0x4
    16e2:	50c080e7          	jalr	1292(ra) # 5bea <printf>
    exit(1);
    16e6:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    16f4:	30050513          	addi	a0,a0,768 # 69f0 <malloc+0xd48>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    171e:	33650513          	addi	a0,a0,822 # 6a50 <malloc+0xda8>
    1722:	00004097          	auipc	ra,0x4
    1726:	4c8080e7          	jalr	1224(ra) # 5bea <printf>
    exit(1);
    172a:	4505                	li	a0,1
...
000000000000173e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    178a:	62aa8a93          	addi	s5,s5,1578 # bdb0 <buf>
      if(cc > sizeof(buf))
    ...
    17a8:	60c70713          	addi	a4,a4,1548 # bdb0 <buf>
    ...
    17e0:	28c50513          	addi	a0,a0,652 # 6a68 <malloc+0xdc0>
    17e4:	00004097          	auipc	ra,0x4
    17e8:	406080e7          	jalr	1030(ra) # 5bea <printf>
    exit(1);
    17ec:	4505                	li	a0,1
    ...
    1806:	5aeb0b13          	addi	s6,s6,1454 # bdb0 <buf>
    ...
    181a:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x85>
{
    ...
    1866:	21e50513          	addi	a0,a0,542 # 6a80 <malloc+0xdd8>
    186a:	00004097          	auipc	ra,0x4
    186e:	380080e7          	jalr	896(ra) # 5bea <printf>
        exit(1);
    1872:	4505                	li	a0,1
    ...
    1882:	21a50513          	addi	a0,a0,538 # 6a98 <malloc+0xdf0>
    1886:	00004097          	auipc	ra,0x4
    188a:	364080e7          	jalr	868(ra) # 5bea <printf>
}
    ...
    18b4:	20050513          	addi	a0,a0,512 # 6ab0 <malloc+0xe08>
    18b8:	00004097          	auipc	ra,0x4
    18bc:	332080e7          	jalr	818(ra) # 5bea <printf>
      exit(1);
    18c0:	4505                	li	a0,1
    ...
    18f4:	1e050513          	addi	a0,a0,480 # 6ad0 <malloc+0xe28>
    18f8:	00004097          	auipc	ra,0x4
    18fc:	2f2080e7          	jalr	754(ra) # 5bea <printf>
    exit(1);
    1900:	4505                	li	a0,1
...
000000000000190a <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1966:	ffe50513          	addi	a0,a0,-2 # 6960 <malloc+0xcb8>
    196a:	00004097          	auipc	ra,0x4
    196e:	280080e7          	jalr	640(ra) # 5bea <printf>
      exit(1);
    1972:	4505                	li	a0,1
    ...
    1982:	16a50513          	addi	a0,a0,362 # 6ae8 <malloc+0xe40>
    1986:	00004097          	auipc	ra,0x4
    198a:	264080e7          	jalr	612(ra) # 5bea <printf>
        exit(1);
    198e:	4505                	li	a0,1
    ...
    199e:	16650513          	addi	a0,a0,358 # 6b00 <malloc+0xe58>
    19a2:	00004097          	auipc	ra,0x4
    19a6:	248080e7          	jalr	584(ra) # 5bea <printf>
        exit(1);
    19aa:	4505                	li	a0,1
...
00000000000019be <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a16:	f4e50513          	addi	a0,a0,-178 # 6960 <malloc+0xcb8>
    1a1a:	00004097          	auipc	ra,0x4
    1a1e:	1d0080e7          	jalr	464(ra) # 5bea <printf>
      exit(1);
    1a22:	4505                	li	a0,1
    ...
    1a3a:	f2a50513          	addi	a0,a0,-214 # 6960 <malloc+0xcb8>
    1a3e:	00004097          	auipc	ra,0x4
    1a42:	1ac080e7          	jalr	428(ra) # 5bea <printf>
        exit(1);
    1a46:	4505                	li	a0,1
...
0000000000001a58 <forkfork>:
{
    ...
    1ab4:	07050513          	addi	a0,a0,112 # 6b20 <malloc+0xe78>
    1ab8:	00004097          	auipc	ra,0x4
    1abc:	132080e7          	jalr	306(ra) # 5bea <printf>
      exit(1);
    1ac0:	4505                	li	a0,1
    ...
    1ac6:	d90080e7          	jalr	-624(ra) # 5852 <exit>
{
    ...
    1b0c:	02850513          	addi	a0,a0,40 # 6b30 <malloc+0xe88>
    1b10:	00004097          	auipc	ra,0x4
    1b14:	0da080e7          	jalr	218(ra) # 5bea <printf>
      exit(1);
    1b18:	4505                	li	a0,1
...
0000000000001b22 <reparent2>:
{
  ...
  exit(0);
    ...
    1b5a:	22a50513          	addi	a0,a0,554 # 6d80 <malloc+0x10d8>
    1b5e:	00004097          	auipc	ra,0x4
    1b62:	08c080e7          	jalr	140(ra) # 5bea <printf>
      exit(1);
    1b66:	4505                	li	a0,1
...
0000000000001b8a <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1bf8:	18c50513          	addi	a0,a0,396 # 6d80 <malloc+0x10d8>
    1bfc:	00004097          	auipc	ra,0x4
    1c00:	fee080e7          	jalr	-18(ra) # 5bea <printf>
      exit(1);
    1c04:	4505                	li	a0,1
    ...
    1c24:	dd850513          	addi	a0,a0,-552 # 69f8 <malloc+0xd50>
    1c28:	00004097          	auipc	ra,0x4
    1c2c:	fc2080e7          	jalr	-62(ra) # 5bea <printf>
          exit(1);
    1c30:	4505                	li	a0,1
    ...
    1c96:	ebe50513          	addi	a0,a0,-322 # 6b50 <malloc+0xea8>
    1c9a:	00004097          	auipc	ra,0x4
    1c9e:	f50080e7          	jalr	-176(ra) # 5bea <printf>
            exit(1);
    1ca2:	4505                	li	a0,1
    ...
    1cca:	ea250513          	addi	a0,a0,-350 # 6b68 <malloc+0xec0>
    1cce:	00004097          	auipc	ra,0x4
    1cd2:	f1c080e7          	jalr	-228(ra) # 5bea <printf>
        exit(1);
    1cd6:	4505                	li	a0,1
    ...
    1d30:	e6450513          	addi	a0,a0,-412 # 6b90 <malloc+0xee8>
    1d34:	00004097          	auipc	ra,0x4
    1d38:	eb6080e7          	jalr	-330(ra) # 5bea <printf>
        exit(1);
    1d3c:	4505                	li	a0,1
...
0000000000001db0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dd0:	3cc50513          	addi	a0,a0,972 # 6198 <malloc+0x4f0>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e0c:	390a8a93          	addi	s5,s5,912 # 6198 <malloc+0x4f0>
      link("cat", "x");
    1e10:	00005b97          	auipc	s7,0x5
    1e14:	da8b8b93          	addi	s7,s7,-600 # 6bb8 <malloc+0xf10>
    1e18:	a091                	j	1e5c <linkunlink+0xac>
    printf("%s: fork failed\n", s);
    1e1a:	85a6                	mv	a1,s1
    1e1c:	00005517          	auipc	a0,0x5
    1e20:	b4450513          	addi	a0,a0,-1212 # 6960 <malloc+0xcb8>
    1e24:	00004097          	auipc	ra,0x4
    1e28:	dc6080e7          	jalr	-570(ra) # 5bea <printf>
    exit(1);
    1e2c:	4505                	li	a0,1
...
0000000000001eb2 <manywrites>:
{
  ...
  exit(0);
    ...
    1f0e:	e7650513          	addi	a0,a0,-394 # 6d80 <malloc+0x10d8>
    1f12:	00004097          	auipc	ra,0x4
    1f16:	cd8080e7          	jalr	-808(ra) # 5bea <printf>
      exit(1);
    1f1a:	4505                	li	a0,1
    ...
    1f4a:	e6ab8b93          	addi	s7,s7,-406 # bdb0 <buf>
    ...
    1fbe:	c0650513          	addi	a0,a0,-1018 # 6bc0 <malloc+0xf18>
    1fc2:	00004097          	auipc	ra,0x4
    1fc6:	c28080e7          	jalr	-984(ra) # 5bea <printf>
            exit(1);
    1fca:	4505                	li	a0,1
    ...
    1fde:	20e50513          	addi	a0,a0,526 # 61e8 <malloc+0x540>
    1fe2:	00004097          	auipc	ra,0x4
    1fe6:	c08080e7          	jalr	-1016(ra) # 5bea <printf>
            exit(1);
    1fea:	4505                	li	a0,1
...
0000000000001ffc <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    202c:	bc850513          	addi	a0,a0,-1080 # 6bf0 <malloc+0xf48>
    2030:	00004097          	auipc	ra,0x4
    2034:	bba080e7          	jalr	-1094(ra) # 5bea <printf>
    exit(1);
    2038:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    208e:	b4e50513          	addi	a0,a0,-1202 # 6bd8 <malloc+0xf30>
    2092:	00004097          	auipc	ra,0x4
    2096:	b58080e7          	jalr	-1192(ra) # 5bea <printf>
    exit(1);
    209a:	4505                	li	a0,1
    ...
    20aa:	b7250513          	addi	a0,a0,-1166 # 6c18 <malloc+0xf70>
    20ae:	00004097          	auipc	ra,0x4
    20b2:	b3c080e7          	jalr	-1220(ra) # 5bea <printf>
      exit(1);
    20b6:	4505                	li	a0,1
    ...
    20c6:	b6e50513          	addi	a0,a0,-1170 # 6c30 <malloc+0xf88>
    20ca:	00004097          	auipc	ra,0x4
    20ce:	b20080e7          	jalr	-1248(ra) # 5bea <printf>
    exit(1);
    20d2:	4505                	li	a0,1
...
00000000000020dc <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    20f8:	35098993          	addi	s3,s3,848 # c350 <buf+0x5a0>
    20fc:	1003d937          	lui	s2,0x1003d
    2100:	090e                	slli	s2,s2,0x3
    2102:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002e6c0>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2146:	81e50513          	addi	a0,a0,-2018 # 6960 <malloc+0xcb8>
    214a:	00004097          	auipc	ra,0x4
    214e:	aa0080e7          	jalr	-1376(ra) # 5bea <printf>
      exit(1);
    2152:	4505                	li	a0,1
    ...
    2168:	ae450513          	addi	a0,a0,-1308 # 6c48 <malloc+0xfa0>
    216c:	00004097          	auipc	ra,0x4
    2170:	a7e080e7          	jalr	-1410(ra) # 5bea <printf>
      exit(1);
    2174:	4505                	li	a0,1
...
0000000000002188 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    21ea:	77a50513          	addi	a0,a0,1914 # 6960 <malloc+0xcb8>
    21ee:	00004097          	auipc	ra,0x4
    21f2:	9fc080e7          	jalr	-1540(ra) # 5bea <printf>
      exit(1);
    21f6:	4505                	li	a0,1
    ...
    2216:	a5650513          	addi	a0,a0,-1450 # 6c68 <malloc+0xfc0>
    221a:	00004097          	auipc	ra,0x4
    221e:	9d0080e7          	jalr	-1584(ra) # 5bea <printf>
      exit(1);
    2222:	4505                	li	a0,1
...
0000000000002236 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2246:	a3e50513          	addi	a0,a0,-1474 # 6c80 <malloc+0xfd8>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2278:	a0c50513          	addi	a0,a0,-1524 # 6c80 <malloc+0xfd8>
  ...
  close(fd);
    ...
    229e:	2fe78793          	addi	a5,a5,766 # 8598 <args.1867>
    22a2:	00006697          	auipc	a3,0x6
    22a6:	3ee68693          	addi	a3,a3,1006 # 8690 <args.1867+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    22aa:	00005717          	auipc	a4,0x5
    22ae:	9e670713          	addi	a4,a4,-1562 # 6c90 <malloc+0xfe8>
    ...
    2302:	a7250513          	addi	a0,a0,-1422 # 6d70 <malloc+0x10c8>
    2306:	00004097          	auipc	ra,0x4
    230a:	8e4080e7          	jalr	-1820(ra) # 5bea <printf>
    exit(1);
    230e:	4505                	li	a0,1
    ...
    2326:	a6e50513          	addi	a0,a0,-1426 # 6d90 <malloc+0x10e8>
    232a:	00004097          	auipc	ra,0x4
    232e:	8c0080e7          	jalr	-1856(ra) # 5bea <printf>
    exit(1);
    2332:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    237a:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <__BSS_END__+0xffffffffffff0240>
    237e:	85a6                	mv	a1,s1
    2380:	00005517          	auipc	a0,0x5
    2384:	a3050513          	addi	a0,a0,-1488 # 6db0 <malloc+0x1108>
    2388:	00004097          	auipc	ra,0x4
    238c:	862080e7          	jalr	-1950(ra) # 5bea <printf>
    exit(1);
    2390:	4505                	li	a0,1
    ...
    23a0:	5c450513          	addi	a0,a0,1476 # 6960 <malloc+0xcb8>
    23a4:	00004097          	auipc	ra,0x4
    23a8:	846080e7          	jalr	-1978(ra) # 5bea <printf>
    exit(1);
    23ac:	4505                	li	a0,1
...
00000000000023c0 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    243a:	61278793          	addi	a5,a5,1554 # 7a48 <malloc+0x1da0>
  ...
  if(ret != -1){
    ...
    247c:	96050513          	addi	a0,a0,-1696 # 6dd8 <malloc+0x1130>
    2480:	00003097          	auipc	ra,0x3
    2484:	76a080e7          	jalr	1898(ra) # 5bea <printf>
    exit(1);
    2488:	4505                	li	a0,1
    ...
    249a:	3ea50513          	addi	a0,a0,1002 # 6880 <malloc+0xbd8>
    249e:	00003097          	auipc	ra,0x3
    24a2:	74c080e7          	jalr	1868(ra) # 5bea <printf>
    exit(1);
    24a6:	4505                	li	a0,1
    ...
    24b8:	3ec50513          	addi	a0,a0,1004 # 68a0 <malloc+0xbf8>
    24bc:	00003097          	auipc	ra,0x3
    24c0:	72e080e7          	jalr	1838(ra) # 5bea <printf>
    exit(1);
    24c4:	4505                	li	a0,1
    ...
    24d8:	3ec50513          	addi	a0,a0,1004 # 68c0 <malloc+0xc18>
    24dc:	00003097          	auipc	ra,0x3
    24e0:	70e080e7          	jalr	1806(ra) # 5bea <printf>
    exit(1);
    24e4:	4505                	li	a0,1
    ...
    24f6:	3f650513          	addi	a0,a0,1014 # 68e8 <malloc+0xc40>
    24fa:	00003097          	auipc	ra,0x3
    24fe:	6f0080e7          	jalr	1776(ra) # 5bea <printf>
    exit(1);
    2502:	4505                	li	a0,1
...
000000000000250c <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2542:	8da50513          	addi	a0,a0,-1830 # 5e18 <malloc+0x170>
  ...
  if(n >= 0){
    ...
    2574:	8c050513          	addi	a0,a0,-1856 # 6e30 <malloc+0x1188>
    2578:	00003097          	auipc	ra,0x3
    257c:	672080e7          	jalr	1650(ra) # 5bea <printf>
    exit(1);
    2580:	4505                	li	a0,1
    ...
    258e:	85650513          	addi	a0,a0,-1962 # 6de0 <malloc+0x1138>
    2592:	00003097          	auipc	ra,0x3
    2596:	658080e7          	jalr	1624(ra) # 5bea <printf>
    exit(1);
    259a:	4505                	li	a0,1
    ...
    25a8:	85450513          	addi	a0,a0,-1964 # 6df8 <malloc+0x1150>
    25ac:	00003097          	auipc	ra,0x3
    25b0:	63e080e7          	jalr	1598(ra) # 5bea <printf>
    exit(1);
    25b4:	4505                	li	a0,1
    ...
    25c2:	85a50513          	addi	a0,a0,-1958 # 6e18 <malloc+0x1170>
    25c6:	00003097          	auipc	ra,0x3
    25ca:	624080e7          	jalr	1572(ra) # 5bea <printf>
    exit(1);
    25ce:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    25e6:	83650513          	addi	a0,a0,-1994 # 5e18 <malloc+0x170>
    25ea:	00003097          	auipc	ra,0x3
    25ee:	2b8080e7          	jalr	696(ra) # 58a2 <unlink>
  fd = open("README", O_RDONLY);
    25f2:	4581                	li	a1,0
    25f4:	00004517          	auipc	a0,0x4
    25f8:	ccc50513          	addi	a0,a0,-820 # 62c0 <malloc+0x618>
  ...
  if(n >= 0){
    ...
    2622:	84250513          	addi	a0,a0,-1982 # 6e60 <malloc+0x11b8>
    2626:	00003097          	auipc	ra,0x3
    262a:	5c4080e7          	jalr	1476(ra) # 5bea <printf>
    exit(1);
    262e:	4505                	li	a0,1
    ...
    263c:	7e050513          	addi	a0,a0,2016 # 6e18 <malloc+0x1170>
    2640:	00003097          	auipc	ra,0x3
    2644:	5aa080e7          	jalr	1450(ra) # 5bea <printf>
    exit(1);
    2648:	4505                	li	a0,1
...
0000000000002666 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    26a4:	6705                	lui	a4,0x1
      *b = 99;
    26a6:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff1240>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    26be:	7ce50513          	addi	a0,a0,1998 # 6e88 <malloc+0x11e0>
    26c2:	00003097          	auipc	ra,0x3
    26c6:	528080e7          	jalr	1320(ra) # 5bea <printf>
    exit(1);
    26ca:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2712:	79a50513          	addi	a0,a0,1946 # 6ea8 <malloc+0x1200>
    2716:	00003097          	auipc	ra,0x3
    271a:	4d4080e7          	jalr	1236(ra) # 5bea <printf>
    exit(1);
    271e:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    2774:	79850513          	addi	a0,a0,1944 # 6f08 <malloc+0x1260>
    2778:	00003097          	auipc	ra,0x3
    277c:	472080e7          	jalr	1138(ra) # 5bea <printf>
    exit(1);
    2780:	4505                	li	a0,1
    ...
    2796:	73650513          	addi	a0,a0,1846 # 6ec8 <malloc+0x1220>
    279a:	00003097          	auipc	ra,0x3
    279e:	450080e7          	jalr	1104(ra) # 5bea <printf>
      exit(1);
    27a2:	4505                	li	a0,1
    ...
    27b2:	73a50513          	addi	a0,a0,1850 # 6ee8 <malloc+0x1240>
    27b6:	00003097          	auipc	ra,0x3
    27ba:	434080e7          	jalr	1076(ra) # 5bea <printf>
    exit(1);
    27be:	4505                	li	a0,1
...
00000000000027ee <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    2850:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f123f>
  a = sbrk(0);
    2854:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    28b4:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f123f>
  ...
  if(c != a){
    ...
    28fc:	63050513          	addi	a0,a0,1584 # 6f28 <malloc+0x1280>
    2900:	00003097          	auipc	ra,0x3
    2904:	2ea080e7          	jalr	746(ra) # 5bea <printf>
    exit(1);
    2908:	4505                	li	a0,1
    ...
    2918:	65c50513          	addi	a0,a0,1628 # 6f70 <malloc+0x12c8>
    291c:	00003097          	auipc	ra,0x3
    2920:	2ce080e7          	jalr	718(ra) # 5bea <printf>
    exit(1);
    2924:	4505                	li	a0,1
    ...
    2938:	65c50513          	addi	a0,a0,1628 # 6f90 <malloc+0x12e8>
    293c:	00003097          	auipc	ra,0x3
    2940:	2ae080e7          	jalr	686(ra) # 5bea <printf>
    exit(1);
    2944:	4505                	li	a0,1
    ...
    2958:	67c50513          	addi	a0,a0,1660 # 6fd0 <malloc+0x1328>
    295c:	00003097          	auipc	ra,0x3
    2960:	28e080e7          	jalr	654(ra) # 5bea <printf>
    exit(1);
    2964:	4505                	li	a0,1
    ...
    2974:	69050513          	addi	a0,a0,1680 # 7000 <malloc+0x1358>
    2978:	00003097          	auipc	ra,0x3
    297c:	272080e7          	jalr	626(ra) # 5bea <printf>
    exit(1);
    2980:	4505                	li	a0,1
    ...
    2994:	6a850513          	addi	a0,a0,1704 # 7038 <malloc+0x1390>
    2998:	00003097          	auipc	ra,0x3
    299c:	252080e7          	jalr	594(ra) # 5bea <printf>
    exit(1);
    29a0:	4505                	li	a0,1
...
00000000000029aa <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    29ce:	69650513          	addi	a0,a0,1686 # 7060 <malloc+0x13b8>
    29d2:	00003097          	auipc	ra,0x3
    29d6:	ec0080e7          	jalr	-320(ra) # 5892 <open>
    29da:	84aa                	mv	s1,a0
  unlink("sbrk");
    29dc:	00004517          	auipc	a0,0x4
    29e0:	68450513          	addi	a0,a0,1668 # 7060 <malloc+0x13b8>
  ...
  if(pipe((int *) a) != 0){
    ...
    2a34:	63850513          	addi	a0,a0,1592 # 7068 <malloc+0x13c0>
    2a38:	00003097          	auipc	ra,0x3
    2a3c:	1b2080e7          	jalr	434(ra) # 5bea <printf>
    exit(1);
    2a40:	4505                	li	a0,1
    ...
    2a50:	63450513          	addi	a0,a0,1588 # 7080 <malloc+0x13d8>
    2a54:	00003097          	auipc	ra,0x3
    2a58:	196080e7          	jalr	406(ra) # 5bea <printf>
    exit(1);
    2a5c:	4505                	li	a0,1
    ...
    2a6c:	00050513          	mv	a0,a0
    2a70:	00003097          	auipc	ra,0x3
    2a74:	17a080e7          	jalr	378(ra) # 5bea <printf>
    exit(1);
    2a78:	4505                	li	a0,1
...
0000000000002a82 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2a96:	60650513          	addi	a0,a0,1542 # 7098 <malloc+0x13f0>
  ...
  close(fd);
    ...
    2ade:	e9e50513          	addi	a0,a0,-354 # 6978 <malloc+0xcd0>
    2ae2:	00003097          	auipc	ra,0x3
    2ae6:	108080e7          	jalr	264(ra) # 5bea <printf>
    exit(1);
    2aea:	4505                	li	a0,1
...
0000000000002af4 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2b2c:	25850513          	addi	a0,a0,600 # 6d80 <malloc+0x10d8>
    2b30:	00003097          	auipc	ra,0x3
    2b34:	0ba080e7          	jalr	186(ra) # 5bea <printf>
    exit(1);
    2b38:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2b82:	20250513          	addi	a0,a0,514 # 6d80 <malloc+0x10d8>
    2b86:	00003097          	auipc	ra,0x3
    2b8a:	064080e7          	jalr	100(ra) # 5bea <printf>
    exit(1);
    2b8e:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2be2:	1a250513          	addi	a0,a0,418 # 6d80 <malloc+0x10d8>
    2be6:	00003097          	auipc	ra,0x3
    2bea:	004080e7          	jalr	4(ra) # 5bea <printf>
    exit(1);
    2bee:	4505                	li	a0,1
...
0000000000002cde <sbrk8000>:
{
  ...
  *(top-1) = *(top-1) + 1;
    2cfe:	fff54783          	lbu	a5,-1(a0) # ffffffff7fffffff <__BSS_END__+0xffffffff7fff123f>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2d56:	02e50513          	addi	a0,a0,46 # 6d80 <malloc+0x10d8>
    2d5a:	00003097          	auipc	ra,0x3
    2d5e:	e90080e7          	jalr	-368(ra) # 5bea <printf>
      exit(1);
    2d62:	4505                	li	a0,1
    ...
    2daa:	38250513          	addi	a0,a0,898 # 6128 <malloc+0x480>
    2dae:	faa43c23          	sd	a0,-72(s0)
    2db2:	00003797          	auipc	a5,0x3
    2db6:	3e678793          	addi	a5,a5,998 # 6198 <malloc+0x4f0>
...
0000000000002dd8 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2de8:	48c50513          	addi	a0,a0,1164 # 7270 <malloc+0x15c8>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2dfa:	2d250513          	addi	a0,a0,722 # 70c8 <malloc+0x1420>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2e10:	31450513          	addi	a0,a0,788 # 7120 <malloc+0x1478>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2e2e:	36e50513          	addi	a0,a0,878 # 7198 <malloc+0x14f0>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2e4a:	3c250513          	addi	a0,a0,962 # 7208 <malloc+0x1560>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2e5c:	40850513          	addi	a0,a0,1032 # 7260 <malloc+0x15b8>
  ...
  unlink("12345678901234");
    ...
    2eda:	1ca50513          	addi	a0,a0,458 # 70a0 <malloc+0x13f8>
    2ede:	00003097          	auipc	ra,0x3
    2ee2:	d0c080e7          	jalr	-756(ra) # 5bea <printf>
    exit(1);
    2ee6:	4505                	li	a0,1
    ...
    2ef6:	1f650513          	addi	a0,a0,502 # 70e8 <malloc+0x1440>
    2efa:	00003097          	auipc	ra,0x3
    2efe:	cf0080e7          	jalr	-784(ra) # 5bea <printf>
    exit(1);
    2f02:	4505                	li	a0,1
    ...
    2f12:	24250513          	addi	a0,a0,578 # 7150 <malloc+0x14a8>
    2f16:	00003097          	auipc	ra,0x3
    2f1a:	cd4080e7          	jalr	-812(ra) # 5bea <printf>
    exit(1);
    2f1e:	4505                	li	a0,1
    ...
    2f2e:	29e50513          	addi	a0,a0,670 # 71c8 <malloc+0x1520>
    2f32:	00003097          	auipc	ra,0x3
    2f36:	cb8080e7          	jalr	-840(ra) # 5bea <printf>
    exit(1);
    2f3a:	4505                	li	a0,1
    ...
    2f4a:	2e250513          	addi	a0,a0,738 # 7228 <malloc+0x1580>
    2f4e:	00003097          	auipc	ra,0x3
    2f52:	c9c080e7          	jalr	-868(ra) # 5bea <printf>
    exit(1);
    2f56:	4505                	li	a0,1
    ...
    2f66:	31e50513          	addi	a0,a0,798 # 7280 <malloc+0x15d8>
    2f6a:	00003097          	auipc	ra,0x3
    2f6e:	c80080e7          	jalr	-896(ra) # 5bea <printf>
    exit(1);
    2f72:	4505                	li	a0,1
...
0000000000002f7c <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2f8c:	33050513          	addi	a0,a0,816 # 72b8 <malloc+0x1610>
  ...
  if(chdir("iputdir") < 0){
    ...
    2fa0:	31c50513          	addi	a0,a0,796 # 72b8 <malloc+0x1610>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2fb4:	34850513          	addi	a0,a0,840 # 72f8 <malloc+0x1650>
  ...
  if(chdir("/") < 0){
    ...
    2fc8:	36450513          	addi	a0,a0,868 # 7328 <malloc+0x1680>
    ...
    2fe8:	2dc50513          	addi	a0,a0,732 # 72c0 <malloc+0x1618>
    2fec:	00003097          	auipc	ra,0x3
    2ff0:	bfe080e7          	jalr	-1026(ra) # 5bea <printf>
    exit(1);
    2ff4:	4505                	li	a0,1
    ...
    3004:	2d850513          	addi	a0,a0,728 # 72d8 <malloc+0x1630>
    3008:	00003097          	auipc	ra,0x3
    300c:	be2080e7          	jalr	-1054(ra) # 5bea <printf>
    exit(1);
    3010:	4505                	li	a0,1
    ...
    3020:	2ec50513          	addi	a0,a0,748 # 7308 <malloc+0x1660>
    3024:	00003097          	auipc	ra,0x3
    3028:	bc6080e7          	jalr	-1082(ra) # 5bea <printf>
    exit(1);
    302c:	4505                	li	a0,1
    ...
    303c:	2f850513          	addi	a0,a0,760 # 7330 <malloc+0x1688>
    3040:	00003097          	auipc	ra,0x3
    3044:	baa080e7          	jalr	-1110(ra) # 5bea <printf>
    exit(1);
    3048:	4505                	li	a0,1
...
0000000000003052 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    3070:	24c50513          	addi	a0,a0,588 # 72b8 <malloc+0x1610>
    ...
    3084:	23850513          	addi	a0,a0,568 # 72b8 <malloc+0x1610>
    ...
    3098:	26450513          	addi	a0,a0,612 # 72f8 <malloc+0x1650>
    ...
    30b8:	8ac50513          	addi	a0,a0,-1876 # 6960 <malloc+0xcb8>
    30bc:	00003097          	auipc	ra,0x3
    30c0:	b2e080e7          	jalr	-1234(ra) # 5bea <printf>
    exit(1);
    30c4:	4505                	li	a0,1
    ...
    30d4:	1f050513          	addi	a0,a0,496 # 72c0 <malloc+0x1618>
    30d8:	00003097          	auipc	ra,0x3
    30dc:	b12080e7          	jalr	-1262(ra) # 5bea <printf>
      exit(1);
    30e0:	4505                	li	a0,1
    ...
    30f0:	25c50513          	addi	a0,a0,604 # 7348 <malloc+0x16a0>
    30f4:	00003097          	auipc	ra,0x3
    30f8:	af6080e7          	jalr	-1290(ra) # 5bea <printf>
      exit(1);
    30fc:	4505                	li	a0,1
    ...
    310c:	20050513          	addi	a0,a0,512 # 7308 <malloc+0x1660>
    3110:	00003097          	auipc	ra,0x3
    3114:	ada080e7          	jalr	-1318(ra) # 5bea <printf>
      exit(1);
    3118:	4505                	li	a0,1
...
000000000000313a <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    314a:	21a50513          	addi	a0,a0,538 # 7360 <malloc+0x16b8>
  ...
  if(chdir("dir0") < 0){
    ...
    315e:	20650513          	addi	a0,a0,518 # 7360 <malloc+0x16b8>
  ...
  if(chdir("..") < 0){
    ...
    3172:	21250513          	addi	a0,a0,530 # 7380 <malloc+0x16d8>
  ...
  if(unlink("dir0") < 0){
    ...
    3186:	1de50513          	addi	a0,a0,478 # 7360 <malloc+0x16b8>
    ...
    31a6:	11e50513          	addi	a0,a0,286 # 72c0 <malloc+0x1618>
    31aa:	00003097          	auipc	ra,0x3
    31ae:	a40080e7          	jalr	-1472(ra) # 5bea <printf>
    exit(1);
    31b2:	4505                	li	a0,1
    ...
    31c2:	1aa50513          	addi	a0,a0,426 # 7368 <malloc+0x16c0>
    31c6:	00003097          	auipc	ra,0x3
    31ca:	a24080e7          	jalr	-1500(ra) # 5bea <printf>
    exit(1);
    31ce:	4505                	li	a0,1
    ...
    31de:	1ae50513          	addi	a0,a0,430 # 7388 <malloc+0x16e0>
    31e2:	00003097          	auipc	ra,0x3
    31e6:	a08080e7          	jalr	-1528(ra) # 5bea <printf>
    exit(1);
    31ea:	4505                	li	a0,1
    ...
    31fa:	1aa50513          	addi	a0,a0,426 # 73a0 <malloc+0x16f8>
    31fe:	00003097          	auipc	ra,0x3
    3202:	9ec080e7          	jalr	-1556(ra) # 5bea <printf>
    exit(1);
    3206:	4505                	li	a0,1
...
0000000000003210 <subdir>:
{
  ...
  unlink("ff");
    ...
    3222:	2ca50513          	addi	a0,a0,714 # 74e8 <malloc+0x1840>
    3226:	00002097          	auipc	ra,0x2
    322a:	67c080e7          	jalr	1660(ra) # 58a2 <unlink>
  if(mkdir("dd") != 0){
    322e:	00004517          	auipc	a0,0x4
    3232:	18a50513          	addi	a0,a0,394 # 73b8 <malloc+0x1710>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    324a:	19250513          	addi	a0,a0,402 # 73d8 <malloc+0x1730>
  ...
  write(fd, "ff", 2);
    ...
    3262:	28a58593          	addi	a1,a1,650 # 74e8 <malloc+0x1840>
  ...
  if(unlink("dd") >= 0){
    ...
    327c:	14050513          	addi	a0,a0,320 # 73b8 <malloc+0x1710>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3290:	1a450513          	addi	a0,a0,420 # 7430 <malloc+0x1788>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    32a8:	1b450513          	addi	a0,a0,436 # 7458 <malloc+0x17b0>
  ...
  write(fd, "FF", 2);
    ...
    32c0:	1cc58593          	addi	a1,a1,460 # 7488 <malloc+0x17e0>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    32dc:	1b850513          	addi	a0,a0,440 # 7490 <malloc+0x17e8>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    32f4:	ac058593          	addi	a1,a1,-1344 # bdb0 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    330a:	aaa74703          	lbu	a4,-1366(a4) # bdb0 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    3324:	1c058593          	addi	a1,a1,448 # 74e0 <malloc+0x1838>
    3328:	00004517          	auipc	a0,0x4
    332c:	13050513          	addi	a0,a0,304 # 7458 <malloc+0x17b0>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3340:	11c50513          	addi	a0,a0,284 # 7458 <malloc+0x17b0>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3356:	10650513          	addi	a0,a0,262 # 7458 <malloc+0x17b0>
  ...
  if(chdir("dd") != 0){
    ...
    336a:	05250513          	addi	a0,a0,82 # 73b8 <malloc+0x1710>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    337e:	1fe50513          	addi	a0,a0,510 # 7578 <malloc+0x18d0>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3392:	21a50513          	addi	a0,a0,538 # 75a8 <malloc+0x1900>
  ...
  if(chdir("./..") != 0){
    ...
    33a6:	23650513          	addi	a0,a0,566 # 75d8 <malloc+0x1930>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    33bc:	12850513          	addi	a0,a0,296 # 74e0 <malloc+0x1838>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    33d4:	9e058593          	addi	a1,a1,-1568 # bdb0 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    33f6:	06650513          	addi	a0,a0,102 # 7458 <malloc+0x17b0>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    340e:	25e50513          	addi	a0,a0,606 # 7668 <malloc+0x19c0>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3426:	27650513          	addi	a0,a0,630 # 7698 <malloc+0x19f0>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    343e:	f7e50513          	addi	a0,a0,-130 # 73b8 <malloc+0x1710>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    3454:	f6850513          	addi	a0,a0,-152 # 73b8 <malloc+0x1710>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    346a:	f5250513          	addi	a0,a0,-174 # 73b8 <malloc+0x1710>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    347e:	2ae58593          	addi	a1,a1,686 # 7728 <malloc+0x1a80>
    3482:	00004517          	auipc	a0,0x4
    3486:	1e650513          	addi	a0,a0,486 # 7668 <malloc+0x19c0>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    349a:	29258593          	addi	a1,a1,658 # 7728 <malloc+0x1a80>
    349e:	00004517          	auipc	a0,0x4
    34a2:	1fa50513          	addi	a0,a0,506 # 7698 <malloc+0x19f0>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    34b6:	02e58593          	addi	a1,a1,46 # 74e0 <malloc+0x1838>
    34ba:	00004517          	auipc	a0,0x4
    34be:	f1e50513          	addi	a0,a0,-226 # 73d8 <malloc+0x1730>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    34d2:	19a50513          	addi	a0,a0,410 # 7668 <malloc+0x19c0>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    34e6:	1b650513          	addi	a0,a0,438 # 7698 <malloc+0x19f0>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    34fa:	fea50513          	addi	a0,a0,-22 # 74e0 <malloc+0x1838>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    350e:	18e50513          	addi	a0,a0,398 # 7698 <malloc+0x19f0>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    3522:	14a50513          	addi	a0,a0,330 # 7668 <malloc+0x19c0>
  ...
  if(chdir("dd/ff") == 0){
    ...
    3536:	ea650513          	addi	a0,a0,-346 # 73d8 <malloc+0x1730>
  ...
  if(chdir("dd/xx") == 0){
    ...
    354a:	33250513          	addi	a0,a0,818 # 7878 <malloc+0x1bd0>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    355e:	f8650513          	addi	a0,a0,-122 # 74e0 <malloc+0x1838>
  ...
  if(unlink("dd/ff") != 0){
    ...
    3572:	e6a50513          	addi	a0,a0,-406 # 73d8 <malloc+0x1730>
  ...
  if(unlink("dd") == 0){
    ...
    3586:	e3650513          	addi	a0,a0,-458 # 73b8 <malloc+0x1710>
  ...
  if(unlink("dd/dd") < 0){
    ...
    359a:	35250513          	addi	a0,a0,850 # 78e8 <malloc+0x1c40>
  ...
  if(unlink("dd") < 0){
    ...
    35ae:	e0e50513          	addi	a0,a0,-498 # 73b8 <malloc+0x1710>
    ...
    35d0:	df450513          	addi	a0,a0,-524 # 73c0 <malloc+0x1718>
    35d4:	00002097          	auipc	ra,0x2
    35d8:	616080e7          	jalr	1558(ra) # 5bea <printf>
    exit(1);
    35dc:	4505                	li	a0,1
    ...
    35ec:	df850513          	addi	a0,a0,-520 # 73e0 <malloc+0x1738>
    35f0:	00002097          	auipc	ra,0x2
    35f4:	5fa080e7          	jalr	1530(ra) # 5bea <printf>
    exit(1);
    35f8:	4505                	li	a0,1
    ...
    3608:	dfc50513          	addi	a0,a0,-516 # 7400 <malloc+0x1758>
    360c:	00002097          	auipc	ra,0x2
    3610:	5de080e7          	jalr	1502(ra) # 5bea <printf>
    exit(1);
    3614:	4505                	li	a0,1
    ...
    3624:	e1850513          	addi	a0,a0,-488 # 7438 <malloc+0x1790>
    3628:	00002097          	auipc	ra,0x2
    362c:	5c2080e7          	jalr	1474(ra) # 5bea <printf>
    exit(1);
    3630:	4505                	li	a0,1
    ...
    3640:	e2c50513          	addi	a0,a0,-468 # 7468 <malloc+0x17c0>
    3644:	00002097          	auipc	ra,0x2
    3648:	5a6080e7          	jalr	1446(ra) # 5bea <printf>
    exit(1);
    364c:	4505                	li	a0,1
    ...
    365c:	e4850513          	addi	a0,a0,-440 # 74a0 <malloc+0x17f8>
    3660:	00002097          	auipc	ra,0x2
    3664:	58a080e7          	jalr	1418(ra) # 5bea <printf>
    exit(1);
    3668:	4505                	li	a0,1
    ...
    3678:	e4c50513          	addi	a0,a0,-436 # 74c0 <malloc+0x1818>
    367c:	00002097          	auipc	ra,0x2
    3680:	56e080e7          	jalr	1390(ra) # 5bea <printf>
    exit(1);
    3684:	4505                	li	a0,1
    ...
    3694:	e6050513          	addi	a0,a0,-416 # 74f0 <malloc+0x1848>
    3698:	00002097          	auipc	ra,0x2
    369c:	552080e7          	jalr	1362(ra) # 5bea <printf>
    exit(1);
    36a0:	4505                	li	a0,1
    ...
    36b0:	e6c50513          	addi	a0,a0,-404 # 7518 <malloc+0x1870>
    36b4:	00002097          	auipc	ra,0x2
    36b8:	536080e7          	jalr	1334(ra) # 5bea <printf>
    exit(1);
    36bc:	4505                	li	a0,1
    ...
    36cc:	e7050513          	addi	a0,a0,-400 # 7538 <malloc+0x1890>
    36d0:	00002097          	auipc	ra,0x2
    36d4:	51a080e7          	jalr	1306(ra) # 5bea <printf>
    exit(1);
    36d8:	4505                	li	a0,1
    ...
    36e8:	e7c50513          	addi	a0,a0,-388 # 7560 <malloc+0x18b8>
    36ec:	00002097          	auipc	ra,0x2
    36f0:	4fe080e7          	jalr	1278(ra) # 5bea <printf>
    exit(1);
    36f4:	4505                	li	a0,1
    ...
    3704:	e8850513          	addi	a0,a0,-376 # 7588 <malloc+0x18e0>
    3708:	00002097          	auipc	ra,0x2
    370c:	4e2080e7          	jalr	1250(ra) # 5bea <printf>
    exit(1);
    3710:	4505                	li	a0,1
    ...
    3720:	e9c50513          	addi	a0,a0,-356 # 75b8 <malloc+0x1910>
    3724:	00002097          	auipc	ra,0x2
    3728:	4c6080e7          	jalr	1222(ra) # 5bea <printf>
    exit(1);
    372c:	4505                	li	a0,1
    ...
    373c:	ea850513          	addi	a0,a0,-344 # 75e0 <malloc+0x1938>
    3740:	00002097          	auipc	ra,0x2
    3744:	4aa080e7          	jalr	1194(ra) # 5bea <printf>
    exit(1);
    3748:	4505                	li	a0,1
    ...
    3758:	ea450513          	addi	a0,a0,-348 # 75f8 <malloc+0x1950>
    375c:	00002097          	auipc	ra,0x2
    3760:	48e080e7          	jalr	1166(ra) # 5bea <printf>
    exit(1);
    3764:	4505                	li	a0,1
    ...
    3774:	ea850513          	addi	a0,a0,-344 # 7618 <malloc+0x1970>
    3778:	00002097          	auipc	ra,0x2
    377c:	472080e7          	jalr	1138(ra) # 5bea <printf>
    exit(1);
    3780:	4505                	li	a0,1
    ...
    3790:	eac50513          	addi	a0,a0,-340 # 7638 <malloc+0x1990>
    3794:	00002097          	auipc	ra,0x2
    3798:	456080e7          	jalr	1110(ra) # 5bea <printf>
    exit(1);
    379c:	4505                	li	a0,1
    ...
    37ac:	ed050513          	addi	a0,a0,-304 # 7678 <malloc+0x19d0>
    37b0:	00002097          	auipc	ra,0x2
    37b4:	43a080e7          	jalr	1082(ra) # 5bea <printf>
    exit(1);
    37b8:	4505                	li	a0,1
    ...
    37c8:	ee450513          	addi	a0,a0,-284 # 76a8 <malloc+0x1a00>
    37cc:	00002097          	auipc	ra,0x2
    37d0:	41e080e7          	jalr	1054(ra) # 5bea <printf>
    exit(1);
    37d4:	4505                	li	a0,1
    ...
    37e4:	ee850513          	addi	a0,a0,-280 # 76c8 <malloc+0x1a20>
    37e8:	00002097          	auipc	ra,0x2
    37ec:	402080e7          	jalr	1026(ra) # 5bea <printf>
    exit(1);
    37f0:	4505                	li	a0,1
    ...
    3800:	eec50513          	addi	a0,a0,-276 # 76e8 <malloc+0x1a40>
    3804:	00002097          	auipc	ra,0x2
    3808:	3e6080e7          	jalr	998(ra) # 5bea <printf>
    exit(1);
    380c:	4505                	li	a0,1
    ...
    381c:	ef050513          	addi	a0,a0,-272 # 7708 <malloc+0x1a60>
    3820:	00002097          	auipc	ra,0x2
    3824:	3ca080e7          	jalr	970(ra) # 5bea <printf>
    exit(1);
    3828:	4505                	li	a0,1
    ...
    3838:	f0450513          	addi	a0,a0,-252 # 7738 <malloc+0x1a90>
    383c:	00002097          	auipc	ra,0x2
    3840:	3ae080e7          	jalr	942(ra) # 5bea <printf>
    exit(1);
    3844:	4505                	li	a0,1
    ...
    3854:	f1050513          	addi	a0,a0,-240 # 7760 <malloc+0x1ab8>
    3858:	00002097          	auipc	ra,0x2
    385c:	392080e7          	jalr	914(ra) # 5bea <printf>
    exit(1);
    3860:	4505                	li	a0,1
    ...
    3870:	f1c50513          	addi	a0,a0,-228 # 7788 <malloc+0x1ae0>
    3874:	00002097          	auipc	ra,0x2
    3878:	376080e7          	jalr	886(ra) # 5bea <printf>
    exit(1);
    387c:	4505                	li	a0,1
    ...
    388c:	f2850513          	addi	a0,a0,-216 # 77b0 <malloc+0x1b08>
    3890:	00002097          	auipc	ra,0x2
    3894:	35a080e7          	jalr	858(ra) # 5bea <printf>
    exit(1);
    3898:	4505                	li	a0,1
    ...
    38a8:	f2c50513          	addi	a0,a0,-212 # 77d0 <malloc+0x1b28>
    38ac:	00002097          	auipc	ra,0x2
    38b0:	33e080e7          	jalr	830(ra) # 5bea <printf>
    exit(1);
    38b4:	4505                	li	a0,1
    ...
    38c4:	f3050513          	addi	a0,a0,-208 # 77f0 <malloc+0x1b48>
    38c8:	00002097          	auipc	ra,0x2
    38cc:	322080e7          	jalr	802(ra) # 5bea <printf>
    exit(1);
    38d0:	4505                	li	a0,1
    ...
    38e0:	f3c50513          	addi	a0,a0,-196 # 7818 <malloc+0x1b70>
    38e4:	00002097          	auipc	ra,0x2
    38e8:	306080e7          	jalr	774(ra) # 5bea <printf>
    exit(1);
    38ec:	4505                	li	a0,1
    ...
    38fc:	f4050513          	addi	a0,a0,-192 # 7838 <malloc+0x1b90>
    3900:	00002097          	auipc	ra,0x2
    3904:	2ea080e7          	jalr	746(ra) # 5bea <printf>
    exit(1);
    3908:	4505                	li	a0,1
    ...
    3918:	f4450513          	addi	a0,a0,-188 # 7858 <malloc+0x1bb0>
    391c:	00002097          	auipc	ra,0x2
    3920:	2ce080e7          	jalr	718(ra) # 5bea <printf>
    exit(1);
    3924:	4505                	li	a0,1
    ...
    3934:	f5050513          	addi	a0,a0,-176 # 7880 <malloc+0x1bd8>
    3938:	00002097          	auipc	ra,0x2
    393c:	2b2080e7          	jalr	690(ra) # 5bea <printf>
    exit(1);
    3940:	4505                	li	a0,1
    ...
    3950:	bcc50513          	addi	a0,a0,-1076 # 7518 <malloc+0x1870>
    3954:	00002097          	auipc	ra,0x2
    3958:	296080e7          	jalr	662(ra) # 5bea <printf>
    exit(1);
    395c:	4505                	li	a0,1
    ...
    396c:	f3850513          	addi	a0,a0,-200 # 78a0 <malloc+0x1bf8>
    3970:	00002097          	auipc	ra,0x2
    3974:	27a080e7          	jalr	634(ra) # 5bea <printf>
    exit(1);
    3978:	4505                	li	a0,1
    ...
    3988:	f3c50513          	addi	a0,a0,-196 # 78c0 <malloc+0x1c18>
    398c:	00002097          	auipc	ra,0x2
    3990:	25e080e7          	jalr	606(ra) # 5bea <printf>
    exit(1);
    3994:	4505                	li	a0,1
    ...
    39a4:	f5050513          	addi	a0,a0,-176 # 78f0 <malloc+0x1c48>
    39a8:	00002097          	auipc	ra,0x2
    39ac:	242080e7          	jalr	578(ra) # 5bea <printf>
    exit(1);
    39b0:	4505                	li	a0,1
    ...
    39c0:	f5450513          	addi	a0,a0,-172 # 7910 <malloc+0x1c68>
    39c4:	00002097          	auipc	ra,0x2
    39c8:	226080e7          	jalr	550(ra) # 5bea <printf>
    exit(1);
    39cc:	4505                	li	a0,1
...
00000000000039d6 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    39e6:	f4650513          	addi	a0,a0,-186 # 7928 <malloc+0x1c80>
  ...
  if(chdir("dots") != 0){
    ...
    39f8:	f3450513          	addi	a0,a0,-204 # 7928 <malloc+0x1c80>
  ...
  if(unlink(".") == 0){
    ...
    3a0a:	dba50513          	addi	a0,a0,-582 # 67c0 <malloc+0xb18>
  ...
  if(unlink("..") == 0){
    ...
    3a1c:	96850513          	addi	a0,a0,-1688 # 7380 <malloc+0x16d8>
  ...
  if(chdir("/") != 0){
    ...
    3a2e:	8fe50513          	addi	a0,a0,-1794 # 7328 <malloc+0x1680>
  ...
  if(unlink("dots/.") == 0){
    ...
    3a40:	f5450513          	addi	a0,a0,-172 # 7990 <malloc+0x1ce8>
  ...
  if(unlink("dots/..") == 0){
    ...
    3a52:	f6a50513          	addi	a0,a0,-150 # 79b8 <malloc+0x1d10>
  ...
  if(unlink("dots") != 0){
    ...
    3a64:	ec850513          	addi	a0,a0,-312 # 7928 <malloc+0x1c80>
    ...
    3a82:	eb250513          	addi	a0,a0,-334 # 7930 <malloc+0x1c88>
    3a86:	00002097          	auipc	ra,0x2
    3a8a:	164080e7          	jalr	356(ra) # 5bea <printf>
    exit(1);
    3a8e:	4505                	li	a0,1
    ...
    3a9e:	eae50513          	addi	a0,a0,-338 # 7948 <malloc+0x1ca0>
    3aa2:	00002097          	auipc	ra,0x2
    3aa6:	148080e7          	jalr	328(ra) # 5bea <printf>
    exit(1);
    3aaa:	4505                	li	a0,1
    ...
    3aba:	eaa50513          	addi	a0,a0,-342 # 7960 <malloc+0x1cb8>
    3abe:	00002097          	auipc	ra,0x2
    3ac2:	12c080e7          	jalr	300(ra) # 5bea <printf>
    exit(1);
    3ac6:	4505                	li	a0,1
    ...
    3ad6:	ea650513          	addi	a0,a0,-346 # 7978 <malloc+0x1cd0>
    3ada:	00002097          	auipc	ra,0x2
    3ade:	110080e7          	jalr	272(ra) # 5bea <printf>
    exit(1);
    3ae2:	4505                	li	a0,1
    ...
    3af2:	84250513          	addi	a0,a0,-1982 # 7330 <malloc+0x1688>
    3af6:	00002097          	auipc	ra,0x2
    3afa:	0f4080e7          	jalr	244(ra) # 5bea <printf>
    exit(1);
    3afe:	4505                	li	a0,1
    ...
    3b0e:	e8e50513          	addi	a0,a0,-370 # 7998 <malloc+0x1cf0>
    3b12:	00002097          	auipc	ra,0x2
    3b16:	0d8080e7          	jalr	216(ra) # 5bea <printf>
    exit(1);
    3b1a:	4505                	li	a0,1
    ...
    3b2a:	e9a50513          	addi	a0,a0,-358 # 79c0 <malloc+0x1d18>
    3b2e:	00002097          	auipc	ra,0x2
    3b32:	0bc080e7          	jalr	188(ra) # 5bea <printf>
    exit(1);
    3b36:	4505                	li	a0,1
    ...
    3b46:	e9e50513          	addi	a0,a0,-354 # 79e0 <malloc+0x1d38>
    3b4a:	00002097          	auipc	ra,0x2
    3b4e:	0a0080e7          	jalr	160(ra) # 5bea <printf>
    exit(1);
    3b52:	4505                	li	a0,1
...
0000000000003b5c <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3b72:	55a50513          	addi	a0,a0,1370 # 60c8 <malloc+0x420>
  ...
  if(chdir("dirfile") == 0){
    ...
    3b8e:	53e50513          	addi	a0,a0,1342 # 60c8 <malloc+0x420>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3ba2:	ea250513          	addi	a0,a0,-350 # 7a40 <malloc+0x1d98>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3bba:	e8a50513          	addi	a0,a0,-374 # 7a40 <malloc+0x1d98>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3bce:	e7650513          	addi	a0,a0,-394 # 7a40 <malloc+0x1d98>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3be2:	e6250513          	addi	a0,a0,-414 # 7a40 <malloc+0x1d98>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3bf6:	e4e58593          	addi	a1,a1,-434 # 7a40 <malloc+0x1d98>
    3bfa:	00002517          	auipc	a0,0x2
    3bfe:	6c650513          	addi	a0,a0,1734 # 62c0 <malloc+0x618>
  ...
  if(unlink("dirfile") != 0){
    ...
    3c12:	4ba50513          	addi	a0,a0,1210 # 60c8 <malloc+0x420>
  ...
  fd = open(".", O_RDWR);
    ...
    3c28:	b9c50513          	addi	a0,a0,-1124 # 67c0 <malloc+0xb18>
  ...
  fd = open(".", 0);
    ...
    3c3e:	b8650513          	addi	a0,a0,-1146 # 67c0 <malloc+0xb18>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3c52:	54a58593          	addi	a1,a1,1354 # 6198 <malloc+0x4f0>
  ...
  close(fd);
    ...
    3c7e:	d8650513          	addi	a0,a0,-634 # 7a00 <malloc+0x1d58>
    3c82:	00002097          	auipc	ra,0x2
    3c86:	f68080e7          	jalr	-152(ra) # 5bea <printf>
    exit(1);
    3c8a:	4505                	li	a0,1
    ...
    3c9a:	d8a50513          	addi	a0,a0,-630 # 7a20 <malloc+0x1d78>
    3c9e:	00002097          	auipc	ra,0x2
    3ca2:	f4c080e7          	jalr	-180(ra) # 5bea <printf>
    exit(1);
    3ca6:	4505                	li	a0,1
    ...
    3cb6:	d9e50513          	addi	a0,a0,-610 # 7a50 <malloc+0x1da8>
    3cba:	00002097          	auipc	ra,0x2
    3cbe:	f30080e7          	jalr	-208(ra) # 5bea <printf>
    exit(1);
    3cc2:	4505                	li	a0,1
    ...
    3cd2:	d8250513          	addi	a0,a0,-638 # 7a50 <malloc+0x1da8>
    3cd6:	00002097          	auipc	ra,0x2
    3cda:	f14080e7          	jalr	-236(ra) # 5bea <printf>
    exit(1);
    3cde:	4505                	li	a0,1
    ...
    3cee:	d8e50513          	addi	a0,a0,-626 # 7a78 <malloc+0x1dd0>
    3cf2:	00002097          	auipc	ra,0x2
    3cf6:	ef8080e7          	jalr	-264(ra) # 5bea <printf>
    exit(1);
    3cfa:	4505                	li	a0,1
    ...
    3d0a:	d9a50513          	addi	a0,a0,-614 # 7aa0 <malloc+0x1df8>
    3d0e:	00002097          	auipc	ra,0x2
    3d12:	edc080e7          	jalr	-292(ra) # 5bea <printf>
    exit(1);
    3d16:	4505                	li	a0,1
    ...
    3d26:	da650513          	addi	a0,a0,-602 # 7ac8 <malloc+0x1e20>
    3d2a:	00002097          	auipc	ra,0x2
    3d2e:	ec0080e7          	jalr	-320(ra) # 5bea <printf>
    exit(1);
    3d32:	4505                	li	a0,1
    ...
    3d42:	db250513          	addi	a0,a0,-590 # 7af0 <malloc+0x1e48>
    3d46:	00002097          	auipc	ra,0x2
    3d4a:	ea4080e7          	jalr	-348(ra) # 5bea <printf>
    exit(1);
    3d4e:	4505                	li	a0,1
    ...
    3d5e:	db650513          	addi	a0,a0,-586 # 7b10 <malloc+0x1e68>
    3d62:	00002097          	auipc	ra,0x2
    3d66:	e88080e7          	jalr	-376(ra) # 5bea <printf>
    exit(1);
    3d6a:	4505                	li	a0,1
    ...
    3d7a:	dc250513          	addi	a0,a0,-574 # 7b38 <malloc+0x1e90>
    3d7e:	00002097          	auipc	ra,0x2
    3d82:	e6c080e7          	jalr	-404(ra) # 5bea <printf>
    exit(1);
    3d86:	4505                	li	a0,1
...
0000000000003d90 <iref>:
{
    ...
    3dae:	da6a0a13          	addi	s4,s4,-602 # 7b50 <malloc+0x1ea8>
    mkdir("");
    3db2:	00004497          	auipc	s1,0x4
    3db6:	8ae48493          	addi	s1,s1,-1874 # 7660 <malloc+0x19b8>
    link("README", "");
    3dba:	00002a97          	auipc	s5,0x2
    3dbe:	506a8a93          	addi	s5,s5,1286 # 62c0 <malloc+0x618>
    fd = open("xx", O_CREATE);
    3dc2:	00004997          	auipc	s3,0x4
    3dc6:	c8698993          	addi	s3,s3,-890 # 7a48 <malloc+0x1da0>
    3dca:	a891                	j	3e1e <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3dcc:	85da                	mv	a1,s6
    3dce:	00004517          	auipc	a0,0x4
    3dd2:	d8a50513          	addi	a0,a0,-630 # 7b58 <malloc+0x1eb0>
    3dd6:	00002097          	auipc	ra,0x2
    3dda:	e14080e7          	jalr	-492(ra) # 5bea <printf>
      exit(1);
    3dde:	4505                	li	a0,1
    ...
    3dee:	d8650513          	addi	a0,a0,-634 # 7b70 <malloc+0x1ec8>
    3df2:	00002097          	auipc	ra,0x2
    3df6:	df8080e7          	jalr	-520(ra) # 5bea <printf>
      exit(1);
    3dfa:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3e82:	50298993          	addi	s3,s3,1282 # 7380 <malloc+0x16d8>
    unlink("irefd");
    3e86:	00004917          	auipc	s2,0x4
    3e8a:	cca90913          	addi	s2,s2,-822 # 7b50 <malloc+0x1ea8>
    chdir("..");
    3e8e:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3eaa:	48250513          	addi	a0,a0,1154 # 7328 <malloc+0x1680>
...
0000000000003eca <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3eda:	cb250513          	addi	a0,a0,-846 # 7b88 <malloc+0x1ee0>
  ...
  if(pid == 0){
    ...
    3efe:	c8e50513          	addi	a0,a0,-882 # 7b88 <malloc+0x1ee0>
    ...
    3f14:	c9850513          	addi	a0,a0,-872 # 7ba8 <malloc+0x1f00>
    3f18:	00002097          	auipc	ra,0x2
    3f1c:	cd2080e7          	jalr	-814(ra) # 5bea <printf>
      exit(1);
    3f20:	4505                	li	a0,1
    ...
    3f30:	c6450513          	addi	a0,a0,-924 # 7b90 <malloc+0x1ee8>
    3f34:	00002097          	auipc	ra,0x2
    3f38:	cb6080e7          	jalr	-842(ra) # 5bea <printf>
    exit(1);
    3f3c:	4505                	li	a0,1
    ...
    3f4c:	a1850513          	addi	a0,a0,-1512 # 6960 <malloc+0xcb8>
    3f50:	00002097          	auipc	ra,0x2
    3f54:	c9a080e7          	jalr	-870(ra) # 5bea <printf>
    exit(1);
    3f58:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3f7a:	c1250513          	addi	a0,a0,-1006 # 7b88 <malloc+0x1ee0>
    ...
    3f8e:	bc650513          	addi	a0,a0,-1082 # 6b50 <malloc+0xea8>
    3f92:	00002097          	auipc	ra,0x2
    3f96:	c58080e7          	jalr	-936(ra) # 5bea <printf>
    exit(1);
    3f9a:	4505                	li	a0,1
...
0000000000003fbc <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3fcc:	c0850513          	addi	a0,a0,-1016 # 7bd0 <malloc+0x1f28>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3ff8:	bdc50513          	addi	a0,a0,-1060 # 7bd0 <malloc+0x1f28>
  ...
  sleep(10); // one second
    ...
    4030:	af450513          	addi	a0,a0,-1292 # 6b20 <malloc+0xe78>
    4034:	00002097          	auipc	ra,0x2
    4038:	bb6080e7          	jalr	-1098(ra) # 5bea <printf>
    exit(1);
    403c:	4505                	li	a0,1
    ...
    404a:	b8a48493          	addi	s1,s1,-1142 # 7bd0 <malloc+0x1f28>
    404e:	4581                	li	a1,0
    4050:	8526                	mv	a0,s1
...
000000000000408c <killstatus>:
{
  ...
  exit(0);
    ...
    40f2:	87250513          	addi	a0,a0,-1934 # 6960 <malloc+0xcb8>
    40f6:	00002097          	auipc	ra,0x2
    40fa:	af4080e7          	jalr	-1292(ra) # 5bea <printf>
      exit(1);
    40fe:	4505                	li	a0,1
    ...
    4118:	acc50513          	addi	a0,a0,-1332 # 7be0 <malloc+0x1f38>
    411c:	00002097          	auipc	ra,0x2
    4120:	ace080e7          	jalr	-1330(ra) # 5bea <printf>
       exit(1);
    4124:	4505                	li	a0,1
...
000000000000412e <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    4158:	9cc50513          	addi	a0,a0,-1588 # 6b20 <malloc+0xe78>
    415c:	00002097          	auipc	ra,0x2
    4160:	a8e080e7          	jalr	-1394(ra) # 5bea <printf>
    exit(1);
    4164:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    4186:	7de50513          	addi	a0,a0,2014 # 6960 <malloc+0xcb8>
    418a:	00002097          	auipc	ra,0x2
    418e:	a60080e7          	jalr	-1440(ra) # 5bea <printf>
    exit(1);
    4192:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    41ca:	fd258593          	addi	a1,a1,-46 # 6198 <malloc+0x4f0>
    ...
    41f4:	77050513          	addi	a0,a0,1904 # 6960 <malloc+0xcb8>
    41f8:	00002097          	auipc	ra,0x2
    41fc:	9f2080e7          	jalr	-1550(ra) # 5bea <printf>
     exit(1);
    4200:	4505                	li	a0,1
    ...
    4210:	9f450513          	addi	a0,a0,-1548 # 7c00 <malloc+0x1f58>
    4214:	00002097          	auipc	ra,0x2
    4218:	9d6080e7          	jalr	-1578(ra) # 5bea <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    4230:	b8458593          	addi	a1,a1,-1148 # bdb0 <buf>
    ...
    424c:	9d050513          	addi	a0,a0,-1584 # 7c18 <malloc+0x1f70>
    4250:	00002097          	auipc	ra,0x2
    4254:	99a080e7          	jalr	-1638(ra) # 5bea <printf>
}
  ...
  printf("kill... ");
    ...
    4278:	9bc50513          	addi	a0,a0,-1604 # 7c30 <malloc+0x1f88>
    427c:	00002097          	auipc	ra,0x2
    4280:	96e080e7          	jalr	-1682(ra) # 5bea <printf>
  kill(pid1);
    4284:	8552                	mv	a0,s4
  ...
  printf("wait... ");
    ...
    42a6:	99e50513          	addi	a0,a0,-1634 # 7c40 <malloc+0x1f98>
    42aa:	00002097          	auipc	ra,0x2
    42ae:	940080e7          	jalr	-1728(ra) # 5bea <printf>
  wait(0);
    42b2:	4501                	li	a0,0
...
00000000000042d2 <reparent>:
{
  ...
  exit(0);
    ...
    4326:	63e50513          	addi	a0,a0,1598 # 6960 <malloc+0xcb8>
    432a:	00002097          	auipc	ra,0x2
    432e:	8c0080e7          	jalr	-1856(ra) # 5bea <printf>
      exit(1);
    4332:	4505                	li	a0,1
    ...
    4342:	7aa50513          	addi	a0,a0,1962 # 6ae8 <malloc+0xe40>
    4346:	00002097          	auipc	ra,0x2
    434a:	8a4080e7          	jalr	-1884(ra) # 5bea <printf>
        exit(1);
    434e:	4505                	li	a0,1
...
0000000000004382 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    43b8:	6b450513          	addi	a0,a0,1716 # 6a68 <malloc+0xdc0>
    43bc:	00002097          	auipc	ra,0x2
    43c0:	82e080e7          	jalr	-2002(ra) # 5bea <printf>
    exit(1);
    43c4:	4505                	li	a0,1
    ...
    43ee:	dae58593          	addi	a1,a1,-594 # 6198 <malloc+0x4f0>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    44b2:	7a250513          	addi	a0,a0,1954 # 7c50 <malloc+0x1fa8>
    44b6:	00001097          	auipc	ra,0x1
    44ba:	734080e7          	jalr	1844(ra) # 5bea <printf>
    exit(1);
    44be:	4505                	li	a0,1
    ...
    44ce:	49650513          	addi	a0,a0,1174 # 6960 <malloc+0xcb8>
    44d2:	00001097          	auipc	ra,0x1
    44d6:	718080e7          	jalr	1816(ra) # 5bea <printf>
    exit(1);
    44da:	4505                	li	a0,1
    ...
    451a:	75a50513          	addi	a0,a0,1882 # 7c70 <malloc+0x1fc8>
    451e:	00001097          	auipc	ra,0x1
    4522:	6cc080e7          	jalr	1740(ra) # 5bea <printf>
    exit(1);
    4526:	4505                	li	a0,1
...
000000000000453a <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4562:	74a080e7          	jalr	1866(ra) # 5ca8 <malloc>
    ...
    45a2:	70250513          	addi	a0,a0,1794 # 7ca0 <malloc+0x1ff8>
    45a6:	00001097          	auipc	ra,0x1
    45aa:	644080e7          	jalr	1604(ra) # 5bea <printf>
      exit(1);
    45ae:	4505                	li	a0,1
...
00000000000045e0 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4676:	64e50513          	addi	a0,a0,1614 # 7cc0 <malloc+0x2018>
    467a:	00001097          	auipc	ra,0x1
    467e:	570080e7          	jalr	1392(ra) # 5bea <printf>
    exit(1);
    4682:	4505                	li	a0,1
    ...
    4692:	65a50513          	addi	a0,a0,1626 # 7ce8 <malloc+0x2040>
    4696:	00001097          	auipc	ra,0x1
    469a:	554080e7          	jalr	1364(ra) # 5bea <printf>
      exit(1);
    469e:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    46d6:	86650513          	addi	a0,a0,-1946 # 5f38 <malloc+0x290>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4716:	5f650513          	addi	a0,a0,1526 # 7d08 <malloc+0x2060>
    471a:	00001097          	auipc	ra,0x1
    471e:	4d0080e7          	jalr	1232(ra) # 5bea <printf>
    exit(1);
    4722:	4505                	li	a0,1
    ...
    4730:	fd2783e3          	beq	a5,s2,46f6 <sharedfd+0x116>
      if(buf[i] == 'c')
    4734:	0007c703          	lbu	a4,0(a5) # 3e800000 <__BSS_END__+0x3e7f1240>
  ...
  unlink("sharedfd");
    ...
    4752:	7ea50513          	addi	a0,a0,2026 # 5f38 <malloc+0x290>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4778:	5bc50513          	addi	a0,a0,1468 # 7d30 <malloc+0x2088>
    477c:	00001097          	auipc	ra,0x1
    4780:	46e080e7          	jalr	1134(ra) # 5bea <printf>
    exit(1);
    4784:	4505                	li	a0,1
...
0000000000004798 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    47bc:	5d878793          	addi	a5,a5,1496 # 5d90 <malloc+0xe8>
    47c0:	f6f43823          	sd	a5,-144(s0)
    47c4:	00001797          	auipc	a5,0x1
    47c8:	5d478793          	addi	a5,a5,1492 # 5d98 <malloc+0xf0>
    47cc:	f6f43c23          	sd	a5,-136(s0)
    47d0:	00001797          	auipc	a5,0x1
    47d4:	5d078793          	addi	a5,a5,1488 # 5da0 <malloc+0xf8>
    47d8:	f8f43023          	sd	a5,-128(s0)
    47dc:	00001797          	auipc	a5,0x1
    47e0:	5cc78793          	addi	a5,a5,1484 # 5da8 <malloc+0x100>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    483a:	57aa0a13          	addi	s4,s4,1402 # bdb0 <buf>
    483e:	00007a97          	auipc	s5,0x7
    4842:	573a8a93          	addi	s5,s5,1395 # bdb1 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4858:	52c50513          	addi	a0,a0,1324 # 6d80 <malloc+0x10d8>
    485c:	00001097          	auipc	ra,0x1
    4860:	38e080e7          	jalr	910(ra) # 5bea <printf>
      exit(1);
    4864:	4505                	li	a0,1
    ...
    48d2:	47a50513          	addi	a0,a0,1146 # 7d48 <malloc+0x20a0>
    48d6:	00001097          	auipc	ra,0x1
    48da:	314080e7          	jalr	788(ra) # 5bea <printf>
        exit(1);
    48de:	4505                	li	a0,1
    ...
    48ec:	47050513          	addi	a0,a0,1136 # 7d58 <malloc+0x20b0>
    48f0:	00001097          	auipc	ra,0x1
    48f4:	2fa080e7          	jalr	762(ra) # 5bea <printf>
          exit(1);
    48f8:	4505                	li	a0,1
    ...
    4910:	46450513          	addi	a0,a0,1124 # 7d70 <malloc+0x20c8>
    4914:	00001097          	auipc	ra,0x1
    4918:	2d6080e7          	jalr	726(ra) # 5bea <printf>
          exit(1);
    491c:	4505                	li	a0,1
    ...
    4940:	47478793          	addi	a5,a5,1140 # bdb0 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    49a0:	3e450513          	addi	a0,a0,996 # 7d80 <malloc+0x20d8>
    49a4:	00001097          	auipc	ra,0x1
    49a8:	246080e7          	jalr	582(ra) # 5bea <printf>
      exit(1);
    49ac:	4505                	li	a0,1
...
00000000000049d4 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4a02:	39ab8b93          	addi	s7,s7,922 # 7d98 <malloc+0x20f0>
  for(i = 0; i < N; i++){
    ...
    4a44:	36050513          	addi	a0,a0,864 # 7da0 <malloc+0x20f8>
    4a48:	00001097          	auipc	ra,0x1
    4a4c:	1a2080e7          	jalr	418(ra) # 5bea <printf>
        exit(1);
    4a50:	4505                	li	a0,1
    ...
    4a62:	33a50513          	addi	a0,a0,826 # 7d98 <malloc+0x20f0>
  ...
  fd = open(".", 0);
    ...
    4a9a:	d2a50513          	addi	a0,a0,-726 # 67c0 <malloc+0xb18>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4ac0:	30450513          	addi	a0,a0,772 # 7dc0 <malloc+0x2118>
    4ac4:	00001097          	auipc	ra,0x1
    4ac8:	126080e7          	jalr	294(ra) # 5bea <printf>
        exit(1);
    4acc:	4505                	li	a0,1
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4b30:	2b450513          	addi	a0,a0,692 # 7de0 <malloc+0x2138>
    4b34:	00001097          	auipc	ra,0x1
    4b38:	0b6080e7          	jalr	182(ra) # 5bea <printf>
        exit(1);
    4b3c:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4b68:	2a450513          	addi	a0,a0,676 # 7e08 <malloc+0x2160>
    4b6c:	00001097          	auipc	ra,0x1
    4b70:	07e080e7          	jalr	126(ra) # 5bea <printf>
    exit(1);
    4b74:	4505                	li	a0,1
    ...
    4b84:	de050513          	addi	a0,a0,-544 # 6960 <malloc+0xcb8>
    4b88:	00001097          	auipc	ra,0x1
    4b8c:	062080e7          	jalr	98(ra) # 5bea <printf>
      exit(1);
    4b90:	4505                	li	a0,1
...
0000000000004d2e <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4d6e:	04690913          	addi	s2,s2,70 # bdb0 <buf>
  for(i = 0; i < N; i++){
    4d72:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    4db6:	08e50513          	addi	a0,a0,142 # 7e40 <malloc+0x2198>
  ...
  for(i = 0; ; i++){
    ...
    4dcc:	fe890913          	addi	s2,s2,-24 # bdb0 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4e1a:	03a50513          	addi	a0,a0,58 # 7e50 <malloc+0x21a8>
    4e1e:	00001097          	auipc	ra,0x1
    4e22:	dcc080e7          	jalr	-564(ra) # 5bea <printf>
    exit(1);
    4e26:	4505                	li	a0,1
    ...
    4e36:	03e50513          	addi	a0,a0,62 # 7e70 <malloc+0x21c8>
    4e3a:	00001097          	auipc	ra,0x1
    4e3e:	db0080e7          	jalr	-592(ra) # 5bea <printf>
      exit(1);
    4e42:	4505                	li	a0,1
    ...
    4e52:	04250513          	addi	a0,a0,66 # 7e90 <malloc+0x21e8>
    4e56:	00001097          	auipc	ra,0x1
    4e5a:	d94080e7          	jalr	-620(ra) # 5bea <printf>
    exit(1);
    4e5e:	4505                	li	a0,1
    ...
    4e6e:	04650513          	addi	a0,a0,70 # 7eb0 <malloc+0x2208>
    4e72:	00001097          	auipc	ra,0x1
    4e76:	d78080e7          	jalr	-648(ra) # 5bea <printf>
      exit(1);
    4e7a:	4505                	li	a0,1
    ...
    4e8a:	04a50513          	addi	a0,a0,74 # 7ed0 <malloc+0x2228>
    4e8e:	00001097          	auipc	ra,0x1
    4e92:	d5c080e7          	jalr	-676(ra) # 5bea <printf>
      exit(1);
    4e96:	4505                	li	a0,1
    ...
    4ea6:	04650513          	addi	a0,a0,70 # 7ee8 <malloc+0x2240>
    4eaa:	00001097          	auipc	ra,0x1
    4eae:	d40080e7          	jalr	-704(ra) # 5bea <printf>
      exit(1);
    4eb2:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    4ed4:	f7050513          	addi	a0,a0,-144 # 7e40 <malloc+0x2198>
    ...
    4ef8:	01450513          	addi	a0,a0,20 # 7f08 <malloc+0x2260>
    4efc:	00001097          	auipc	ra,0x1
    4f00:	cee080e7          	jalr	-786(ra) # 5bea <printf>
    exit(1);
    4f04:	4505                	li	a0,1
...
0000000000004f0e <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4f30:	ffc50513          	addi	a0,a0,-4 # 7f28 <malloc+0x2280>
    4f34:	00001097          	auipc	ra,0x1
    4f38:	cb6080e7          	jalr	-842(ra) # 5bea <printf>
  for(nfiles = 0; ; nfiles++){
    4f3c:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4f50:	fecc8c93          	addi	s9,s9,-20 # 7f38 <malloc+0x2290>
    int total = 0;
    4f54:	4d81                	li	s11,0
      int cc = write(fd, buf, BSIZE);
    4f56:	00007a17          	auipc	s4,0x7
    4f5a:	e5aa0a13          	addi	s4,s4,-422 # bdb0 <buf>
    name[0] = 'f';
    ...
    4fa8:	c46080e7          	jalr	-954(ra) # 5bea <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    4fca:	f8250513          	addi	a0,a0,-126 # 7f48 <malloc+0x22a0>
    4fce:	00001097          	auipc	ra,0x1
    4fd2:	c1c080e7          	jalr	-996(ra) # 5bea <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    5040:	f2c50513          	addi	a0,a0,-212 # 7f68 <malloc+0x22c0>
    5044:	00001097          	auipc	ra,0x1
    5048:	ba6080e7          	jalr	-1114(ra) # 5bea <printf>
}
    ...
    5090:	ecc50513          	addi	a0,a0,-308 # 7f58 <malloc+0x22b0>
    5094:	00001097          	auipc	ra,0x1
    5098:	b56080e7          	jalr	-1194(ra) # 5bea <printf>
    close(fd);
    509c:	854a                	mv	a0,s2
...
00000000000050ae <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    5122:	e6250513          	addi	a0,a0,-414 # 7f80 <malloc+0x22d8>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    513a:	06258593          	addi	a1,a1,98 # 6198 <malloc+0x4f0>
    ...
    5150:	e5450513          	addi	a0,a0,-428 # 7fa0 <malloc+0x22f8>
    5154:	00001097          	auipc	ra,0x1
    5158:	a96080e7          	jalr	-1386(ra) # 5bea <printf>
    exit(1);
    515c:	4505                	li	a0,1
    ...
    516a:	e2250513          	addi	a0,a0,-478 # 7f88 <malloc+0x22e0>
    516e:	00001097          	auipc	ra,0x1
    5172:	a7c080e7          	jalr	-1412(ra) # 5bea <printf>
      exit(1);
    5176:	4505                	li	a0,1
    ...
    5184:	e0850513          	addi	a0,a0,-504 # 7f88 <malloc+0x22e0>
    5188:	00001097          	auipc	ra,0x1
    518c:	a62080e7          	jalr	-1438(ra) # 5bea <printf>
    exit(1);
    5190:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    51a8:	ddc50513          	addi	a0,a0,-548 # 7f80 <malloc+0x22d8>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    51fe:	f9e90913          	addi	s2,s2,-98 # 6198 <malloc+0x4f0>
      uint64 a = (uint64) sbrk(4096);
    ...
    5232:	dc250513          	addi	a0,a0,-574 # 7ff0 <malloc+0x2348>
    5236:	00001097          	auipc	ra,0x1
    523a:	9b4080e7          	jalr	-1612(ra) # 5bea <printf>
        exit(1);
    523e:	4505                	li	a0,1
    ...
    524c:	d6850513          	addi	a0,a0,-664 # 7fb0 <malloc+0x2308>
    5250:	00001097          	auipc	ra,0x1
    5254:	99a080e7          	jalr	-1638(ra) # 5bea <printf>
    exit(1);
    5258:	4505                	li	a0,1
    ...
    5266:	d6e50513          	addi	a0,a0,-658 # 7fd0 <malloc+0x2328>
    526a:	00001097          	auipc	ra,0x1
    526e:	980080e7          	jalr	-1664(ra) # 5bea <printf>
    exit(1);
    5272:	4505                	li	a0,1
  ...
  while(1){
    ...
    52b4:	d6050513          	addi	a0,a0,-672 # 8010 <malloc+0x2368>
    52b8:	00001097          	auipc	ra,0x1
    52bc:	932080e7          	jalr	-1742(ra) # 5bea <printf>
      exit(1);
    52c0:	4505                	li	a0,1
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5304:	d3050513          	addi	a0,a0,-720 # 8030 <malloc+0x2388>
    5308:	00001097          	auipc	ra,0x1
    530c:	8e2080e7          	jalr	-1822(ra) # 5bea <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    5334:	d2850513          	addi	a0,a0,-728 # 8058 <malloc+0x23b0>
    5338:	00001097          	auipc	ra,0x1
    533c:	8b2080e7          	jalr	-1870(ra) # 5bea <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    5358:	cec50513          	addi	a0,a0,-788 # 8040 <malloc+0x2398>
    535c:	00001097          	auipc	ra,0x1
    5360:	88e080e7          	jalr	-1906(ra) # 5bea <printf>
    exit(1);
    5364:	4505                	li	a0,1
    ...
    5380:	ce450513          	addi	a0,a0,-796 # 8060 <malloc+0x23b8>
    5384:	00001097          	auipc	ra,0x1
    5388:	866080e7          	jalr	-1946(ra) # 5bea <printf>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    53ca:	db278793          	addi	a5,a5,-590 # 8178 <malloc+0x24d0>
    53ce:	bd040713          	addi	a4,s0,-1072
    53d2:	00003317          	auipc	t1,0x3
    53d6:	19630313          	addi	t1,t1,406 # 8568 <malloc+0x28c0>
  ...
  printf("usertests starting\n");
    ...
    540a:	d1250513          	addi	a0,a0,-750 # 8118 <malloc+0x2470>
    540e:	00000097          	auipc	ra,0x0
    5412:	7dc080e7          	jalr	2012(ra) # 5bea <printf>
  int free0 = countfree();
  ...
  if(fail){
    ...
    5442:	c9250513          	addi	a0,a0,-878 # 80d0 <malloc+0x2428>
    5446:	00000097          	auipc	ra,0x0
    544a:	7a4080e7          	jalr	1956(ra) # 5bea <printf>
    exit(1);
    544e:	4505                	li	a0,1
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    545e:	c0e58593          	addi	a1,a1,-1010 # 8068 <malloc+0x23c0>
    ...
    5474:	ce058593          	addi	a1,a1,-800 # 8150 <malloc+0x24a8>
    ...
    5498:	bdc50513          	addi	a0,a0,-1060 # 8070 <malloc+0x23c8>
    549c:	00000097          	auipc	ra,0x0
    54a0:	74e080e7          	jalr	1870(ra) # 5bea <printf>
    exit(1);
    54a4:	4505                	li	a0,1
    ...
    54c2:	72c080e7          	jalr	1836(ra) # 5bea <printf>
        if(continuous != 2)
  ...
  if(fail){
    ...
    5504:	bb850513          	addi	a0,a0,-1096 # 80b8 <malloc+0x2410>
    5508:	00000097          	auipc	ra,0x0
    550c:	6e2080e7          	jalr	1762(ra) # 5bea <printf>
    exit(1);
    5510:	4505                	li	a0,1
    ...
    551e:	be650513          	addi	a0,a0,-1050 # 8100 <malloc+0x2458>
    5522:	00000097          	auipc	ra,0x0
    5526:	6c8080e7          	jalr	1736(ra) # 5bea <printf>
    exit(0);
    552a:	4501                	li	a0,0
    ...
    553a:	6b4080e7          	jalr	1716(ra) # 5bea <printf>
        if(continuous != 2)
    ...
    557c:	c0078793          	addi	a5,a5,-1024 # 8178 <malloc+0x24d0>
    5580:	bd040713          	addi	a4,s0,-1072
    5584:	00003317          	auipc	t1,0x3
    5588:	fe430313          	addi	t1,t1,-28 # 8568 <malloc+0x28c0>
    ...
    55bc:	b7850513          	addi	a0,a0,-1160 # 8130 <malloc+0x2488>
    55c0:	00000097          	auipc	ra,0x0
    55c4:	62a080e7          	jalr	1578(ra) # 5bea <printf>
        printf("SOME TESTS FAILED\n");
    55c8:	00003a97          	auipc	s5,0x3
    55cc:	af0a8a93          	addi	s5,s5,-1296 # 80b8 <malloc+0x2410>
        if(continuous != 2)
    55d0:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    55d2:	00003b17          	auipc	s6,0x3
    55d6:	ac6b0b13          	addi	s6,s6,-1338 # 8098 <malloc+0x23f0>
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    5928:	f4e080e7          	jalr	-178(ra) # 5872 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
    ...
    5946:	0805c863          	bltz	a1,59d6 <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
  ...
  do{
    ...
    595a:	c1a50513          	addi	a0,a0,-998 # 8570 <digits>
    595e:	883a                	mv	a6,a4
  ...
  if(neg)
    5982:	00088b63          	beqz	a7,5998 <printint+0x64>
    buf[i++] = '-';
    5986:	fd040793          	addi	a5,s0,-48
    598a:	973e                	add	a4,a4,a5
    598c:	02d00793          	li	a5,45
    5990:	fef70823          	sb	a5,-16(a4)
    5994:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    5998:	02e05863          	blez	a4,59c8 <printint+0x94>
    599c:	fc040793          	addi	a5,s0,-64
    59a0:	00e78933          	add	s2,a5,a4
    59a4:	fff78993          	addi	s3,a5,-1
    59a8:	99ba                	add	s3,s3,a4
    59aa:	377d                	addiw	a4,a4,-1
    59ac:	1702                	slli	a4,a4,0x20
    59ae:	9301                	srli	a4,a4,0x20
    59b0:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    59b4:	fff94583          	lbu	a1,-1(s2)
    59b8:	8526                	mv	a0,s1
    59ba:	00000097          	auipc	ra,0x0
    59be:	f58080e7          	jalr	-168(ra) # 5912 <putc>
  while(--i >= 0)
    59c2:	197d                	addi	s2,s2,-1
    59c4:	ff3918e3          	bne	s2,s3,59b4 <printint+0x80>
}
    59c8:	70e2                	ld	ra,56(sp)
    59ca:	7442                	ld	s0,48(sp)
    59cc:	74a2                	ld	s1,40(sp)
    59ce:	7902                	ld	s2,32(sp)
    59d0:	69e2                	ld	s3,24(sp)
    59d2:	6121                	addi	sp,sp,64
    59d4:	8082                	ret
    x = -xx;
    59d6:	40b005bb          	negw	a1,a1
    neg = 1;
    59da:	4885                	li	a7,1
    x = -xx;
    59dc:	bf8d                	j	594e <printint+0x1a>

00000000000059de <vprintf>:
}
...
{
    59de:	7119                	addi	sp,sp,-128
    59e0:	fc86                	sd	ra,120(sp)
    59e2:	f8a2                	sd	s0,112(sp)
    59e4:	f4a6                	sd	s1,104(sp)
    59e6:	f0ca                	sd	s2,96(sp)
    59e8:	ecce                	sd	s3,88(sp)
    59ea:	e8d2                	sd	s4,80(sp)
    59ec:	e4d6                	sd	s5,72(sp)
    59ee:	e0da                	sd	s6,64(sp)
    59f0:	fc5e                	sd	s7,56(sp)
    59f2:	f862                	sd	s8,48(sp)
    59f4:	f466                	sd	s9,40(sp)
    59f6:	f06a                	sd	s10,32(sp)
    59f8:	ec6e                	sd	s11,24(sp)
  ...
  state = 0;
  for(i = 0; fmt[i]; i++){
    59fc:	0005c903          	lbu	s2,0(a1)
    5a00:	18090f63          	beqz	s2,5b9e <vprintf+0x1c0>
    5a04:	8aaa                	mv	s5,a0
    5a06:	8b32                	mv	s6,a2
    5a08:	00158493          	addi	s1,a1,1
  state = 0;
    5a0c:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    5a0e:	02500a13          	li	s4,37
      if(c == 'd'){
    5a12:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
    5a16:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
    5a1a:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
    5a1e:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5a22:	00003b97          	auipc	s7,0x3
    5a26:	b4eb8b93          	addi	s7,s7,-1202 # 8570 <digits>
    5a2a:	a839                	j	5a48 <vprintf+0x6a>
        putc(fd, c);
    5a2c:	85ca                	mv	a1,s2
    5a2e:	8556                	mv	a0,s5
    5a30:	00000097          	auipc	ra,0x0
    5a34:	ee2080e7          	jalr	-286(ra) # 5912 <putc>
    5a38:	a019                	j	5a3e <vprintf+0x60>
    } else if(state == '%'){
    5a3a:	01498f63          	beq	s3,s4,5a58 <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    5a3e:	0485                	addi	s1,s1,1
    5a40:	fff4c903          	lbu	s2,-1(s1)
    5a44:	14090d63          	beqz	s2,5b9e <vprintf+0x1c0>
    c = fmt[i] & 0xff;
    5a48:	0009079b          	sext.w	a5,s2
    if(state == 0){
    5a4c:	fe0997e3          	bnez	s3,5a3a <vprintf+0x5c>
      if(c == '%'){
    5a50:	fd479ee3          	bne	a5,s4,5a2c <vprintf+0x4e>
        state = '%';
    5a54:	89be                	mv	s3,a5
    5a56:	b7e5                	j	5a3e <vprintf+0x60>
      if(c == 'd'){
    5a58:	05878063          	beq	a5,s8,5a98 <vprintf+0xba>
      } else if(c == 'l') {
    5a5c:	05978c63          	beq	a5,s9,5ab4 <vprintf+0xd6>
      } else if(c == 'x') {
    5a60:	07a78863          	beq	a5,s10,5ad0 <vprintf+0xf2>
      } else if(c == 'p') {
    5a64:	09b78463          	beq	a5,s11,5aec <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    5a68:	07300713          	li	a4,115
    5a6c:	0ce78663          	beq	a5,a4,5b38 <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    5a70:	06300713          	li	a4,99
    5a74:	0ee78e63          	beq	a5,a4,5b70 <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    5a78:	11478863          	beq	a5,s4,5b88 <vprintf+0x1aa>
        putc(fd, c);
      } else {
    ...
    5a84:	e92080e7          	jalr	-366(ra) # 5912 <putc>
        putc(fd, c);
    5a88:	85ca                	mv	a1,s2
    5a8a:	8556                	mv	a0,s5
    5a8c:	00000097          	auipc	ra,0x0
    5a90:	e86080e7          	jalr	-378(ra) # 5912 <putc>
      }
      state = 0;
    5a94:	4981                	li	s3,0
    5a96:	b765                	j	5a3e <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    5a98:	008b0913          	addi	s2,s6,8
    5a9c:	4685                	li	a3,1
    5a9e:	4629                	li	a2,10
    5aa0:	000b2583          	lw	a1,0(s6)
    5aa4:	8556                	mv	a0,s5
    5aa6:	00000097          	auipc	ra,0x0
    5aaa:	e8e080e7          	jalr	-370(ra) # 5934 <printint>
    5aae:	8b4a                	mv	s6,s2
      state = 0;
    5ab0:	4981                	li	s3,0
    5ab2:	b771                	j	5a3e <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    5ab4:	008b0913          	addi	s2,s6,8
    5ab8:	4681                	li	a3,0
    5aba:	4629                	li	a2,10
    5abc:	000b2583          	lw	a1,0(s6)
    5ac0:	8556                	mv	a0,s5
    5ac2:	00000097          	auipc	ra,0x0
    5ac6:	e72080e7          	jalr	-398(ra) # 5934 <printint>
    5aca:	8b4a                	mv	s6,s2
      state = 0;
    5acc:	4981                	li	s3,0
    5ace:	bf85                	j	5a3e <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    5ad0:	008b0913          	addi	s2,s6,8
    5ad4:	4681                	li	a3,0
    5ad6:	4641                	li	a2,16
    5ad8:	000b2583          	lw	a1,0(s6)
    5adc:	8556                	mv	a0,s5
    5ade:	00000097          	auipc	ra,0x0
    5ae2:	e56080e7          	jalr	-426(ra) # 5934 <printint>
    5ae6:	8b4a                	mv	s6,s2
      state = 0;
    5ae8:	4981                	li	s3,0
    5aea:	bf91                	j	5a3e <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    5aec:	008b0793          	addi	a5,s6,8
    5af0:	f8f43423          	sd	a5,-120(s0)
    5af4:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    5af8:	03000593          	li	a1,48
    5afc:	8556                	mv	a0,s5
    5afe:	00000097          	auipc	ra,0x0
    5b02:	e14080e7          	jalr	-492(ra) # 5912 <putc>
  putc(fd, 'x');
    5b06:	85ea                	mv	a1,s10
    5b08:	8556                	mv	a0,s5
    5b0a:	00000097          	auipc	ra,0x0
    5b0e:	e08080e7          	jalr	-504(ra) # 5912 <putc>
    5b12:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5b14:	03c9d793          	srli	a5,s3,0x3c
    5b18:	97de                	add	a5,a5,s7
    5b1a:	0007c583          	lbu	a1,0(a5)
    5b1e:	8556                	mv	a0,s5
    5b20:	00000097          	auipc	ra,0x0
    5b24:	df2080e7          	jalr	-526(ra) # 5912 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5b28:	0992                	slli	s3,s3,0x4
    5b2a:	397d                	addiw	s2,s2,-1
    5b2c:	fe0914e3          	bnez	s2,5b14 <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    5b30:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    5b34:	4981                	li	s3,0
    5b36:	b721                	j	5a3e <vprintf+0x60>
        s = va_arg(ap, char*);
    5b38:	008b0993          	addi	s3,s6,8
    5b3c:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    5b40:	02090163          	beqz	s2,5b62 <vprintf+0x184>
        while(*s != 0){
    5b44:	00094583          	lbu	a1,0(s2)
    5b48:	c9a1                	beqz	a1,5b98 <vprintf+0x1ba>
          putc(fd, *s);
    5b4a:	8556                	mv	a0,s5
    5b4c:	00000097          	auipc	ra,0x0
    5b50:	dc6080e7          	jalr	-570(ra) # 5912 <putc>
          s++;
    5b54:	0905                	addi	s2,s2,1
        while(*s != 0){
    5b56:	00094583          	lbu	a1,0(s2)
    5b5a:	f9e5                	bnez	a1,5b4a <vprintf+0x16c>
        s = va_arg(ap, char*);
    5b5c:	8b4e                	mv	s6,s3
      state = 0;
    5b5e:	4981                	li	s3,0
    5b60:	bdf9                	j	5a3e <vprintf+0x60>
          s = "(null)";
    5b62:	00003917          	auipc	s2,0x3
    5b66:	a0690913          	addi	s2,s2,-1530 # 8568 <malloc+0x28c0>
        while(*s != 0){
    5b6a:	02800593          	li	a1,40
    5b6e:	bff1                	j	5b4a <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    5b70:	008b0913          	addi	s2,s6,8
    5b74:	000b4583          	lbu	a1,0(s6)
    5b78:	8556                	mv	a0,s5
    5b7a:	00000097          	auipc	ra,0x0
    5b7e:	d98080e7          	jalr	-616(ra) # 5912 <putc>
    5b82:	8b4a                	mv	s6,s2
      state = 0;
    5b84:	4981                	li	s3,0
    5b86:	bd65                	j	5a3e <vprintf+0x60>
        putc(fd, c);
    5b88:	85d2                	mv	a1,s4
    5b8a:	8556                	mv	a0,s5
    5b8c:	00000097          	auipc	ra,0x0
    5b90:	d86080e7          	jalr	-634(ra) # 5912 <putc>
      state = 0;
    5b94:	4981                	li	s3,0
    5b96:	b565                	j	5a3e <vprintf+0x60>
        s = va_arg(ap, char*);
    5b98:	8b4e                	mv	s6,s3
      state = 0;
    5b9a:	4981                	li	s3,0
    5b9c:	b54d                	j	5a3e <vprintf+0x60>
    }
  }
}
    5b9e:	70e6                	ld	ra,120(sp)
    5ba0:	7446                	ld	s0,112(sp)
    5ba2:	74a6                	ld	s1,104(sp)
    5ba4:	7906                	ld	s2,96(sp)
    5ba6:	69e6                	ld	s3,88(sp)
    5ba8:	6a46                	ld	s4,80(sp)
    5baa:	6aa6                	ld	s5,72(sp)
    5bac:	6b06                	ld	s6,64(sp)
    5bae:	7be2                	ld	s7,56(sp)
    5bb0:	7c42                	ld	s8,48(sp)
    5bb2:	7ca2                	ld	s9,40(sp)
    5bb4:	7d02                	ld	s10,32(sp)
    5bb6:	6de2                	ld	s11,24(sp)
    5bb8:	6109                	addi	sp,sp,128
    5bba:	8082                	ret

0000000000005bbc <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    5bbc:	715d                	addi	sp,sp,-80
    5bbe:	ec06                	sd	ra,24(sp)
    5bc0:	e822                	sd	s0,16(sp)
    5bc2:	1000                	addi	s0,sp,32
    5bc4:	e010                	sd	a2,0(s0)
    5bc6:	e414                	sd	a3,8(s0)
    5bc8:	e818                	sd	a4,16(s0)
    5bca:	ec1c                	sd	a5,24(s0)
    5bcc:	03043023          	sd	a6,32(s0)
    5bd0:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    5bd4:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5bd8:	8622                	mv	a2,s0
    5bda:	00000097          	auipc	ra,0x0
    5bde:	e04080e7          	jalr	-508(ra) # 59de <vprintf>
}
    5be2:	60e2                	ld	ra,24(sp)
    5be4:	6442                	ld	s0,16(sp)
    5be6:	6161                	addi	sp,sp,80
    5be8:	8082                	ret

0000000000005bea <printf>:

void
printf(const char *fmt, ...)
{
    5bea:	711d                	addi	sp,sp,-96
    5bec:	ec06                	sd	ra,24(sp)
    5bee:	e822                	sd	s0,16(sp)
    5bf0:	1000                	addi	s0,sp,32
    5bf2:	e40c                	sd	a1,8(s0)
    5bf4:	e810                	sd	a2,16(s0)
    5bf6:	ec14                	sd	a3,24(s0)
    5bf8:	f018                	sd	a4,32(s0)
    5bfa:	f41c                	sd	a5,40(s0)
    5bfc:	03043823          	sd	a6,48(s0)
    5c00:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5c04:	00840613          	addi	a2,s0,8
    5c08:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    5c0c:	85aa                	mv	a1,a0
    5c0e:	4505                	li	a0,1
    5c10:	00000097          	auipc	ra,0x0
    5c14:	dce080e7          	jalr	-562(ra) # 59de <vprintf>
}
    5c18:	60e2                	ld	ra,24(sp)
    5c1a:	6442                	ld	s0,16(sp)
    5c1c:	6125                	addi	sp,sp,96
    5c1e:	8082                	ret

0000000000005c20 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    5c20:	1141                	addi	sp,sp,-16
    5c22:	e422                	sd	s0,8(sp)
    5c24:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5c26:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5c2a:	00003797          	auipc	a5,0x3
    5c2e:	9667b783          	ld	a5,-1690(a5) # 8590 <freep>
    5c32:	a805                	j	5c62 <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5c34:	4618                	lw	a4,8(a2)
    5c36:	9db9                	addw	a1,a1,a4
    5c38:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5c3c:	6398                	ld	a4,0(a5)
    5c3e:	6318                	ld	a4,0(a4)
    5c40:	fee53823          	sd	a4,-16(a0)
    5c44:	a091                	j	5c88 <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5c46:	ff852703          	lw	a4,-8(a0)
    5c4a:	9e39                	addw	a2,a2,a4
    5c4c:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    5c4e:	ff053703          	ld	a4,-16(a0)
    5c52:	e398                	sd	a4,0(a5)
    5c54:	a099                	j	5c9a <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5c56:	6398                	ld	a4,0(a5)
    5c58:	00e7e463          	bltu	a5,a4,5c60 <free+0x40>
    5c5c:	00e6ea63          	bltu	a3,a4,5c70 <free+0x50>
{
    5c60:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5c62:	fed7fae3          	bgeu	a5,a3,5c56 <free+0x36>
    5c66:	6398                	ld	a4,0(a5)
    5c68:	00e6e463          	bltu	a3,a4,5c70 <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5c6c:	fee7eae3          	bltu	a5,a4,5c60 <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    5c70:	ff852583          	lw	a1,-8(a0)
    5c74:	6390                	ld	a2,0(a5)
    5c76:	02059713          	slli	a4,a1,0x20
    5c7a:	9301                	srli	a4,a4,0x20
    5c7c:	0712                	slli	a4,a4,0x4
    5c7e:	9736                	add	a4,a4,a3
    5c80:	fae60ae3          	beq	a2,a4,5c34 <free+0x14>
    bp->s.ptr = p->s.ptr;
    5c84:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5c88:	4790                	lw	a2,8(a5)
    5c8a:	02061713          	slli	a4,a2,0x20
    5c8e:	9301                	srli	a4,a4,0x20
    5c90:	0712                	slli	a4,a4,0x4
    5c92:	973e                	add	a4,a4,a5
    5c94:	fae689e3          	beq	a3,a4,5c46 <free+0x26>
  } else
    p->s.ptr = bp;
    5c98:	e394                	sd	a3,0(a5)
  freep = p;
    5c9a:	00003717          	auipc	a4,0x3
    5c9e:	8ef73b23          	sd	a5,-1802(a4) # 8590 <freep>
}
    5ca2:	6422                	ld	s0,8(sp)
    5ca4:	0141                	addi	sp,sp,16
    5ca6:	8082                	ret

0000000000005ca8 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    ...
    5cb4:	e852                	sd	s4,16(sp)
    5cb6:	e456                	sd	s5,8(sp)
    5cb8:	e05a                	sd	s6,0(sp)
    5cba:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5cbc:	02051493          	slli	s1,a0,0x20
    5cc0:	9081                	srli	s1,s1,0x20
    5cc2:	04bd                	addi	s1,s1,15
    5cc4:	8091                	srli	s1,s1,0x4
    5cc6:	0014899b          	addiw	s3,s1,1
    5cca:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    5ccc:	00003517          	auipc	a0,0x3
    5cd0:	8c453503          	ld	a0,-1852(a0) # 8590 <freep>
    5cd4:	c515                	beqz	a0,5d00 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5cd6:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5cd8:	4798                	lw	a4,8(a5)
    5cda:	02977f63          	bgeu	a4,s1,5d18 <malloc+0x70>
    5cde:	8a4e                	mv	s4,s3
    5ce0:	0009871b          	sext.w	a4,s3
    5ce4:	6685                	lui	a3,0x1
    5ce6:	00d77363          	bgeu	a4,a3,5cec <malloc+0x44>
    5cea:	6a05                	lui	s4,0x1
    5cec:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    5cf0:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    5cf4:	00003917          	auipc	s2,0x3
    5cf8:	89c90913          	addi	s2,s2,-1892 # 8590 <freep>
  if(p == (char*)-1)
    5cfc:	5afd                	li	s5,-1
    5cfe:	a88d                	j	5d70 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    5d00:	00009797          	auipc	a5,0x9
    5d04:	0b078793          	addi	a5,a5,176 # edb0 <base>
    5d08:	00003717          	auipc	a4,0x3
    5d0c:	88f73423          	sd	a5,-1912(a4) # 8590 <freep>
    5d10:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5d12:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5d16:	b7e1                	j	5cde <malloc+0x36>
      if(p->s.size == nunits)
    5d18:	02e48b63          	beq	s1,a4,5d4e <malloc+0xa6>
        p->s.size -= nunits;
    5d1c:	4137073b          	subw	a4,a4,s3
    5d20:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5d22:	1702                	slli	a4,a4,0x20
    5d24:	9301                	srli	a4,a4,0x20
    5d26:	0712                	slli	a4,a4,0x4
    5d28:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5d2a:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5d2e:	00003717          	auipc	a4,0x3
    5d32:	86a73123          	sd	a0,-1950(a4) # 8590 <freep>
      return (void*)(p + 1);
    5d36:	01078513          	addi	a0,a5,16
      if((p = morecore(nunits)) == 0)
        return 0;
  }
}
    5d3a:	70e2                	ld	ra,56(sp)
    5d3c:	7442                	ld	s0,48(sp)
    5d3e:	74a2                	ld	s1,40(sp)
    5d40:	7902                	ld	s2,32(sp)
    5d42:	69e2                	ld	s3,24(sp)
    5d44:	6a42                	ld	s4,16(sp)
    5d46:	6aa2                	ld	s5,8(sp)
    5d48:	6b02                	ld	s6,0(sp)
    5d4a:	6121                	addi	sp,sp,64
    5d4c:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    5d4e:	6398                	ld	a4,0(a5)
    5d50:	e118                	sd	a4,0(a0)
    5d52:	bff1                	j	5d2e <malloc+0x86>
  hp->s.size = nu;
    5d54:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5d58:	0541                	addi	a0,a0,16
    5d5a:	00000097          	auipc	ra,0x0
    5d5e:	ec6080e7          	jalr	-314(ra) # 5c20 <free>
  return freep;
    5d62:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    5d66:	d971                	beqz	a0,5d3a <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5d68:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5d6a:	4798                	lw	a4,8(a5)
    5d6c:	fa9776e3          	bgeu	a4,s1,5d18 <malloc+0x70>
    if(p == freep)
    5d70:	00093703          	ld	a4,0(s2)
    5d74:	853e                	mv	a0,a5
    5d76:	fef719e3          	bne	a4,a5,5d68 <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    5d7a:	8552                	mv	a0,s4
    5d7c:	00000097          	auipc	ra,0x0
    5d80:	b5e080e7          	jalr	-1186(ra) # 58da <sbrk>
  if(p == (char*)-1)
    5d84:	fd5518e3          	bne	a0,s5,5d54 <malloc+0xac>
        return 0;
    5d88:	4501                	li	a0,0
    5d8a:	bf45                	j	5d3a <malloc+0x92>
