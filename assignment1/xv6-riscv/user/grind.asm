...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      9e:	30650513          	addi	a0,a0,774 # 13a0 <malloc+0xe4>
      a2:	00001097          	auipc	ra,0x1
      a6:	e2c080e7          	jalr	-468(ra) # ece <mkdir>
  if(chdir("grindir") != 0){
      aa:	00001517          	auipc	a0,0x1
      ae:	2f650513          	addi	a0,a0,758 # 13a0 <malloc+0xe4>
      b2:	00001097          	auipc	ra,0x1
      b6:	e24080e7          	jalr	-476(ra) # ed6 <chdir>
      ba:	cd11                	beqz	a0,d6 <go+0x5e>
    printf("grind: chdir grindir failed\n");
      bc:	00001517          	auipc	a0,0x1
      c0:	2ec50513          	addi	a0,a0,748 # 13a8 <malloc+0xec>
      c4:	00001097          	auipc	ra,0x1
      c8:	13a080e7          	jalr	314(ra) # 11fe <printf>
    exit(1);
      cc:	4505                	li	a0,1
  ...
  chdir("/");
      ...
      da:	2f250513          	addi	a0,a0,754 # 13c8 <malloc+0x10c>
  ...
  while(1){
    ...
    if((iters % 500) == 0)
      ...
      ea:	2f298993          	addi	s3,s3,754 # 13d8 <malloc+0x11c>
      ee:	c489                	beqz	s1,f8 <go+0x80>
      f0:	00001997          	auipc	s3,0x1
      f4:	2e098993          	addi	s3,s3,736 # 13d0 <malloc+0x114>
    iters++;
      f8:	4485                	li	s1,1
  int fd = -1;
      fa:	597d                	li	s2,-1
     ...
     100:	5bca0a13          	addi	s4,s4,1468 # 16b8 <buf.1245>
     104:	a825                	j	13c <go+0xc4>
      close(open("grindir/../a", O_CREATE|O_RDWR));
     106:	20200593          	li	a1,514
     10a:	00001517          	auipc	a0,0x1
     10e:	2d650513          	addi	a0,a0,726 # 13e0 <malloc+0x124>
    ...
    if(what == 1){
     ...
     2a2:	3ba58593          	addi	a1,a1,954 # 1658 <malloc+0x39c>
     ...
     2c6:	39e50513          	addi	a0,a0,926 # 1660 <malloc+0x3a4>
     2ca:	00001097          	auipc	ra,0x1
     2ce:	f34080e7          	jalr	-204(ra) # 11fe <printf>
        exit(1);
     2d2:	4505                	li	a0,1
     ...
     2e4:	11050513          	addi	a0,a0,272 # 13f0 <malloc+0x134>
     ...
     36c:	0a850513          	addi	a0,a0,168 # 1410 <malloc+0x154>
     ...
     38e:	09650513          	addi	a0,a0,150 # 1420 <malloc+0x164>
     ...
     3c6:	01e50513          	addi	a0,a0,30 # 13e0 <malloc+0x124>
     3ca:	00001097          	auipc	ra,0x1
     3ce:	b04080e7          	jalr	-1276(ra) # ece <mkdir>
      close(open("a/../a/./a", O_CREATE|O_RDWR));
     3d2:	20200593          	li	a1,514
     3d6:	00001517          	auipc	a0,0x1
     3da:	06250513          	addi	a0,a0,98 # 1438 <malloc+0x17c>
     ...
     4b8:	fec50513          	addi	a0,a0,-20 # 14a0 <malloc+0x1e4>
     4bc:	00001097          	auipc	ra,0x1
     4c0:	d42080e7          	jalr	-702(ra) # 11fe <printf>
        exit(1);
     4c4:	4505                	li	a0,1
     ...
     506:	f9e50513          	addi	a0,a0,-98 # 14a0 <malloc+0x1e4>
     50a:	00001097          	auipc	ra,0x1
     50e:	cf4080e7          	jalr	-780(ra) # 11fe <printf>
        exit(1);
     512:	4505                	li	a0,1
     ...
     518:	952080e7          	jalr	-1710(ra) # e66 <exit>
      sbrk(6011);
     51c:	6505                	lui	a0,0x1
     51e:	77b50513          	addi	a0,a0,1915 # 177b <buf.1245+0xc3>
     ...
     566:	f5650513          	addi	a0,a0,-170 # 14b8 <malloc+0x1fc>
     ...
     592:	ef250513          	addi	a0,a0,-270 # 1480 <malloc+0x1c4>
     ...
     5b4:	ef050513          	addi	a0,a0,-272 # 14a0 <malloc+0x1e4>
     5b8:	00001097          	auipc	ra,0x1
     5bc:	c46080e7          	jalr	-954(ra) # 11fe <printf>
        exit(1);
     5c0:	4505                	li	a0,1
     ...
     5ce:	efe50513          	addi	a0,a0,-258 # 14c8 <malloc+0x20c>
     5d2:	00001097          	auipc	ra,0x1
     5d6:	c2c080e7          	jalr	-980(ra) # 11fe <printf>
        exit(1);
     5da:	4505                	li	a0,1
     ...
     61c:	e8850513          	addi	a0,a0,-376 # 14a0 <malloc+0x1e4>
     620:	00001097          	auipc	ra,0x1
     624:	bde080e7          	jalr	-1058(ra) # 11fe <printf>
        exit(1);
     628:	4505                	li	a0,1
     ...
     678:	e6c50513          	addi	a0,a0,-404 # 14e0 <malloc+0x224>
     67c:	00001097          	auipc	ra,0x1
     680:	b82080e7          	jalr	-1150(ra) # 11fe <printf>
        exit(1);
     684:	4505                	li	a0,1
     ...
     6a4:	e5858593          	addi	a1,a1,-424 # 14f8 <malloc+0x23c>
     ...
     6e0:	e2450513          	addi	a0,a0,-476 # 1500 <malloc+0x244>
     6e4:	00001097          	auipc	ra,0x1
     6e8:	b1a080e7          	jalr	-1254(ra) # 11fe <printf>
     6ec:	b7f9                	j	6ba <go+0x642>
          printf("grind: pipe read failed\n");
     6ee:	00001517          	auipc	a0,0x1
     6f2:	e3250513          	addi	a0,a0,-462 # 1520 <malloc+0x264>
     6f6:	00001097          	auipc	ra,0x1
     6fa:	b08080e7          	jalr	-1272(ra) # 11fe <printf>
     6fe:	bfd1                	j	6d2 <go+0x65a>
        printf("grind: fork failed\n");
     700:	00001517          	auipc	a0,0x1
     704:	da050513          	addi	a0,a0,-608 # 14a0 <malloc+0x1e4>
     708:	00001097          	auipc	ra,0x1
     70c:	af6080e7          	jalr	-1290(ra) # 11fe <printf>
        exit(1);
     710:	4505                	li	a0,1
     ...
     7a6:	cfe50513          	addi	a0,a0,-770 # 14a0 <malloc+0x1e4>
     7aa:	00001097          	auipc	ra,0x1
     7ae:	a54080e7          	jalr	-1452(ra) # 11fe <printf>
        exit(1);
     7b2:	4505                	li	a0,1
     ...
     7c0:	d8450513          	addi	a0,a0,-636 # 1540 <malloc+0x284>
     7c4:	00000097          	auipc	ra,0x0
     7c8:	6f2080e7          	jalr	1778(ra) # eb6 <unlink>
      int fd1 = open("c", O_CREATE|O_RDWR);
     7cc:	20200593          	li	a1,514
     7d0:	00001517          	auipc	a0,0x1
     7d4:	d7050513          	addi	a0,a0,-656 # 1540 <malloc+0x284>
     ...
     7ec:	d1058593          	addi	a1,a1,-752 # 14f8 <malloc+0x23c>
     ...
     832:	d1250513          	addi	a0,a0,-750 # 1540 <malloc+0x284>
     836:	00000097          	auipc	ra,0x0
     83a:	680080e7          	jalr	1664(ra) # eb6 <unlink>
     83e:	b0d5                	j	122 <go+0xaa>
        printf("grind: create c failed\n");
     840:	00001517          	auipc	a0,0x1
     844:	d0850513          	addi	a0,a0,-760 # 1548 <malloc+0x28c>
     848:	00001097          	auipc	ra,0x1
     84c:	9b6080e7          	jalr	-1610(ra) # 11fe <printf>
        exit(1);
     850:	4505                	li	a0,1
     ...
     85e:	d0650513          	addi	a0,a0,-762 # 1560 <malloc+0x2a4>
     862:	00001097          	auipc	ra,0x1
     866:	99c080e7          	jalr	-1636(ra) # 11fe <printf>
        exit(1);
     86a:	4505                	li	a0,1
     ...
     878:	d0450513          	addi	a0,a0,-764 # 1578 <malloc+0x2bc>
     87c:	00001097          	auipc	ra,0x1
     880:	982080e7          	jalr	-1662(ra) # 11fe <printf>
        exit(1);
     884:	4505                	li	a0,1
     ...
     894:	d0050513          	addi	a0,a0,-768 # 1590 <malloc+0x2d4>
     898:	00001097          	auipc	ra,0x1
     89c:	966080e7          	jalr	-1690(ra) # 11fe <printf>
        exit(1);
     8a0:	4505                	li	a0,1
     ...
     8ae:	d0e50513          	addi	a0,a0,-754 # 15b8 <malloc+0x2fc>
     8b2:	00001097          	auipc	ra,0x1
     8b6:	94c080e7          	jalr	-1716(ra) # 11fe <printf>
        exit(1);
     8ba:	4505                	li	a0,1
     ...
     8c8:	c1c58593          	addi	a1,a1,-996 # 14e0 <malloc+0x224>
     8cc:	4509                	li	a0,2
     8ce:	00001097          	auipc	ra,0x1
     8d2:	902080e7          	jalr	-1790(ra) # 11d0 <fprintf>
        exit(1);
     8d6:	4505                	li	a0,1
     ...
     8e4:	c0058593          	addi	a1,a1,-1024 # 14e0 <malloc+0x224>
     8e8:	4509                	li	a0,2
     8ea:	00001097          	auipc	ra,0x1
     8ee:	8e6080e7          	jalr	-1818(ra) # 11d0 <fprintf>
        exit(1);
     8f2:	4505                	li	a0,1
     ...
     940:	ca458593          	addi	a1,a1,-860 # 15e0 <malloc+0x324>
     944:	4509                	li	a0,2
     946:	00001097          	auipc	ra,0x1
     94a:	88a080e7          	jalr	-1910(ra) # 11d0 <fprintf>
          exit(1);
     94e:	4505                	li	a0,1
     ...
     9b4:	af058593          	addi	a1,a1,-1296 # 14a0 <malloc+0x1e4>
     9b8:	4509                	li	a0,2
     9ba:	00001097          	auipc	ra,0x1
     9be:	816080e7          	jalr	-2026(ra) # 11d0 <fprintf>
        exit(3);
     9c2:	450d                	li	a0,3
     ...
     a00:	be458593          	addi	a1,a1,-1052 # 15e0 <malloc+0x324>
     a04:	4509                	li	a0,2
     a06:	00000097          	auipc	ra,0x0
     a0a:	7ca080e7          	jalr	1994(ra) # 11d0 <fprintf>
          exit(4);
     a0e:	4511                	li	a0,4
     ...
     a44:	ba058593          	addi	a1,a1,-1120 # 15e0 <malloc+0x324>
     a48:	4509                	li	a0,2
     a4a:	00000097          	auipc	ra,0x0
     a4e:	786080e7          	jalr	1926(ra) # 11d0 <fprintf>
          exit(5);
     a52:	4515                	li	a0,5
     ...
     a6c:	bc878793          	addi	a5,a5,-1080 # 1630 <malloc+0x374>
     a70:	faf43423          	sd	a5,-88(s0)
     a74:	fa043823          	sd	zero,-80(s0)
        exec("/cat", args);
     a78:	fa840593          	addi	a1,s0,-88
     a7c:	00001517          	auipc	a0,0x1
     a80:	bbc50513          	addi	a0,a0,-1092 # 1638 <malloc+0x37c>
     a84:	00000097          	auipc	ra,0x0
     a88:	41a080e7          	jalr	1050(ra) # e9e <exec>
        fprintf(2, "grind: cat: not found\n");
     a8c:	00001597          	auipc	a1,0x1
     a90:	bb458593          	addi	a1,a1,-1100 # 1640 <malloc+0x384>
     a94:	4509                	li	a0,2
     a96:	00000097          	auipc	ra,0x0
     a9a:	73a080e7          	jalr	1850(ra) # 11d0 <fprintf>
        exit(6);
     a9e:	4519                	li	a0,6
     ...
     aac:	9f858593          	addi	a1,a1,-1544 # 14a0 <malloc+0x1e4>
     ab0:	4509                	li	a0,2
     ab2:	00000097          	auipc	ra,0x0
     ab6:	71e080e7          	jalr	1822(ra) # 11d0 <fprintf>
        exit(7);
     aba:	451d                	li	a0,7
...
iter()
{
  ...
  unlink("a");
     ...
     ad4:	9b050513          	addi	a0,a0,-1616 # 1480 <malloc+0x1c4>
     ad8:	00000097          	auipc	ra,0x0
     adc:	3de080e7          	jalr	990(ra) # eb6 <unlink>
  unlink("b");
     ae0:	00001517          	auipc	a0,0x1
     ae4:	95050513          	addi	a0,a0,-1712 # 1430 <malloc+0x174>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     b18:	98c50513          	addi	a0,a0,-1652 # 14a0 <malloc+0x1e4>
     b1c:	00000097          	auipc	ra,0x0
     b20:	6e2080e7          	jalr	1762(ra) # 11fe <printf>
    exit(1);
     b24:	4505                	li	a0,1
  ...
  if(pid2 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     b5a:	94a50513          	addi	a0,a0,-1718 # 14a0 <malloc+0x1e4>
     b5e:	00000097          	auipc	ra,0x0
     b62:	6a0080e7          	jalr	1696(ra) # 11fe <printf>
    exit(1);
     b66:	4505                	li	a0,1
...
putc(int fd, char c)
{
     ...
     f2e:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
     f32:	4605                	li	a2,1
     f34:	fef40593          	addi	a1,s0,-17
     f38:	00000097          	auipc	ra,0x0
     f3c:	f4e080e7          	jalr	-178(ra) # e86 <write>
}
     f40:	60e2                	ld	ra,24(sp)
     f42:	6442                	ld	s0,16(sp)
     f44:	6105                	addi	sp,sp,32
     f46:	8082                	ret

0000000000000f48 <printint>:
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
  if(sgn && xx < 0){
     f58:	c299                	beqz	a3,f5e <printint+0x16>
     f5a:	0805c863          	bltz	a1,fea <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
     f5e:	2581                	sext.w	a1,a1
  neg = 0;
     f60:	4881                	li	a7,0
     f62:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
     f68:	2601                	sext.w	a2,a2
     f6a:	00000517          	auipc	a0,0x0
     f6e:	72650513          	addi	a0,a0,1830 # 1690 <digits>
     f72:	883a                	mv	a6,a4
     f74:	2705                	addiw	a4,a4,1
     f76:	02c5f7bb          	remuw	a5,a1,a2
     f7a:	1782                	slli	a5,a5,0x20
     f7c:	9381                	srli	a5,a5,0x20
     f7e:	97aa                	add	a5,a5,a0
     f80:	0007c783          	lbu	a5,0(a5)
     f84:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
     f88:	0005879b          	sext.w	a5,a1
     f8c:	02c5d5bb          	divuw	a1,a1,a2
     f90:	0685                	addi	a3,a3,1
     f92:	fec7f0e3          	bgeu	a5,a2,f72 <printint+0x2a>
  if(neg)
     f96:	00088b63          	beqz	a7,fac <printint+0x64>
    buf[i++] = '-';
     f9a:	fd040793          	addi	a5,s0,-48
     f9e:	973e                	add	a4,a4,a5
     fa0:	02d00793          	li	a5,45
     fa4:	fef70823          	sb	a5,-16(a4)
     fa8:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
     fac:	02e05863          	blez	a4,fdc <printint+0x94>
     fb0:	fc040793          	addi	a5,s0,-64
     fb4:	00e78933          	add	s2,a5,a4
     fb8:	fff78993          	addi	s3,a5,-1
     fbc:	99ba                	add	s3,s3,a4
     fbe:	377d                	addiw	a4,a4,-1
     fc0:	1702                	slli	a4,a4,0x20
     fc2:	9301                	srli	a4,a4,0x20
     fc4:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
     fc8:	fff94583          	lbu	a1,-1(s2)
     fcc:	8526                	mv	a0,s1
     fce:	00000097          	auipc	ra,0x0
     fd2:	f58080e7          	jalr	-168(ra) # f26 <putc>
  while(--i >= 0)
     fd6:	197d                	addi	s2,s2,-1
     fd8:	ff3918e3          	bne	s2,s3,fc8 <printint+0x80>
}
     fdc:	70e2                	ld	ra,56(sp)
     fde:	7442                	ld	s0,48(sp)
     fe0:	74a2                	ld	s1,40(sp)
     fe2:	7902                	ld	s2,32(sp)
     fe4:	69e2                	ld	s3,24(sp)
     fe6:	6121                	addi	sp,sp,64
     fe8:	8082                	ret
    x = -xx;
     fea:	40b005bb          	negw	a1,a1
    neg = 1;
     fee:	4885                	li	a7,1
    x = -xx;
     ff0:	bf8d                	j	f62 <printint+0x1a>

0000000000000ff2 <vprintf>:
}
...
{
     ff2:	7119                	addi	sp,sp,-128
     ff4:	fc86                	sd	ra,120(sp)
     ff6:	f8a2                	sd	s0,112(sp)
     ff8:	f4a6                	sd	s1,104(sp)
     ffa:	f0ca                	sd	s2,96(sp)
     ffc:	ecce                	sd	s3,88(sp)
     ffe:	e8d2                	sd	s4,80(sp)
    1000:	e4d6                	sd	s5,72(sp)
    1002:	e0da                	sd	s6,64(sp)
    1004:	fc5e                	sd	s7,56(sp)
    1006:	f862                	sd	s8,48(sp)
    1008:	f466                	sd	s9,40(sp)
    100a:	f06a                	sd	s10,32(sp)
    100c:	ec6e                	sd	s11,24(sp)
  ...
  state = 0;
  for(i = 0; fmt[i]; i++){
    1010:	0005c903          	lbu	s2,0(a1)
    1014:	18090f63          	beqz	s2,11b2 <vprintf+0x1c0>
    1018:	8aaa                	mv	s5,a0
    101a:	8b32                	mv	s6,a2
    101c:	00158493          	addi	s1,a1,1
  state = 0;
    1020:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    1022:	02500a13          	li	s4,37
      if(c == 'd'){
    1026:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
    102a:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
    102e:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
    1032:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    1036:	00000b97          	auipc	s7,0x0
    103a:	65ab8b93          	addi	s7,s7,1626 # 1690 <digits>
    103e:	a839                	j	105c <vprintf+0x6a>
        putc(fd, c);
    1040:	85ca                	mv	a1,s2
    1042:	8556                	mv	a0,s5
    1044:	00000097          	auipc	ra,0x0
    1048:	ee2080e7          	jalr	-286(ra) # f26 <putc>
    104c:	a019                	j	1052 <vprintf+0x60>
    } else if(state == '%'){
    104e:	01498f63          	beq	s3,s4,106c <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    1052:	0485                	addi	s1,s1,1
    1054:	fff4c903          	lbu	s2,-1(s1)
    1058:	14090d63          	beqz	s2,11b2 <vprintf+0x1c0>
    c = fmt[i] & 0xff;
    105c:	0009079b          	sext.w	a5,s2
    if(state == 0){
    1060:	fe0997e3          	bnez	s3,104e <vprintf+0x5c>
      if(c == '%'){
    1064:	fd479ee3          	bne	a5,s4,1040 <vprintf+0x4e>
        state = '%';
    1068:	89be                	mv	s3,a5
    106a:	b7e5                	j	1052 <vprintf+0x60>
      if(c == 'd'){
    106c:	05878063          	beq	a5,s8,10ac <vprintf+0xba>
      } else if(c == 'l') {
    1070:	05978c63          	beq	a5,s9,10c8 <vprintf+0xd6>
      } else if(c == 'x') {
    1074:	07a78863          	beq	a5,s10,10e4 <vprintf+0xf2>
      } else if(c == 'p') {
    1078:	09b78463          	beq	a5,s11,1100 <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    107c:	07300713          	li	a4,115
    1080:	0ce78663          	beq	a5,a4,114c <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    1088:	0ee78e63          	beq	a5,a4,1184 <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    108c:	11478863          	beq	a5,s4,119c <vprintf+0x1aa>
        putc(fd, c);
      } else {
    ...
    1098:	e92080e7          	jalr	-366(ra) # f26 <putc>
        putc(fd, c);
    109c:	85ca                	mv	a1,s2
    109e:	8556                	mv	a0,s5
    10a0:	00000097          	auipc	ra,0x0
    10a4:	e86080e7          	jalr	-378(ra) # f26 <putc>
      }
      state = 0;
    10a8:	4981                	li	s3,0
    10aa:	b765                	j	1052 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    ...
    10be:	e8e080e7          	jalr	-370(ra) # f48 <printint>
    10c2:	8b4a                	mv	s6,s2
      state = 0;
    10c4:	4981                	li	s3,0
    10c6:	b771                	j	1052 <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    10c8:	008b0913          	addi	s2,s6,8
    10cc:	4681                	li	a3,0
    10ce:	4629                	li	a2,10
    10d0:	000b2583          	lw	a1,0(s6)
    10d4:	8556                	mv	a0,s5
    10d6:	00000097          	auipc	ra,0x0
    10da:	e72080e7          	jalr	-398(ra) # f48 <printint>
    10de:	8b4a                	mv	s6,s2
      state = 0;
    10e0:	4981                	li	s3,0
    10e2:	bf85                	j	1052 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    10e4:	008b0913          	addi	s2,s6,8
    10e8:	4681                	li	a3,0
    10ea:	4641                	li	a2,16
    10ec:	000b2583          	lw	a1,0(s6)
    10f0:	8556                	mv	a0,s5
    10f2:	00000097          	auipc	ra,0x0
    10f6:	e56080e7          	jalr	-426(ra) # f48 <printint>
    10fa:	8b4a                	mv	s6,s2
      state = 0;
    10fc:	4981                	li	s3,0
    10fe:	bf91                	j	1052 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    1100:	008b0793          	addi	a5,s6,8
    1104:	f8f43423          	sd	a5,-120(s0)
    1108:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    110c:	03000593          	li	a1,48
    1110:	8556                	mv	a0,s5
    1112:	00000097          	auipc	ra,0x0
    1116:	e14080e7          	jalr	-492(ra) # f26 <putc>
  putc(fd, 'x');
    111a:	85ea                	mv	a1,s10
    111c:	8556                	mv	a0,s5
    111e:	00000097          	auipc	ra,0x0
    1122:	e08080e7          	jalr	-504(ra) # f26 <putc>
    1126:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    ...
    1138:	df2080e7          	jalr	-526(ra) # f26 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    113c:	0992                	slli	s3,s3,0x4
    113e:	397d                	addiw	s2,s2,-1
    1140:	fe0914e3          	bnez	s2,1128 <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    1144:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    1148:	4981                	li	s3,0
    114a:	b721                	j	1052 <vprintf+0x60>
        s = va_arg(ap, char*);
    114c:	008b0993          	addi	s3,s6,8
    1150:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    1154:	02090163          	beqz	s2,1176 <vprintf+0x184>
        while(*s != 0){
    1158:	00094583          	lbu	a1,0(s2)
    115c:	c9a1                	beqz	a1,11ac <vprintf+0x1ba>
          putc(fd, *s);
    115e:	8556                	mv	a0,s5
    1160:	00000097          	auipc	ra,0x0
    1164:	dc6080e7          	jalr	-570(ra) # f26 <putc>
          s++;
    1168:	0905                	addi	s2,s2,1
        while(*s != 0){
    116a:	00094583          	lbu	a1,0(s2)
    116e:	f9e5                	bnez	a1,115e <vprintf+0x16c>
        s = va_arg(ap, char*);
    1170:	8b4e                	mv	s6,s3
      state = 0;
    1172:	4981                	li	s3,0
    1174:	bdf9                	j	1052 <vprintf+0x60>
          s = "(null)";
    1176:	00000917          	auipc	s2,0x0
    117a:	51290913          	addi	s2,s2,1298 # 1688 <malloc+0x3cc>
        while(*s != 0){
    117e:	02800593          	li	a1,40
    1182:	bff1                	j	115e <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    1184:	008b0913          	addi	s2,s6,8
    1188:	000b4583          	lbu	a1,0(s6)
    118c:	8556                	mv	a0,s5
    118e:	00000097          	auipc	ra,0x0
    1192:	d98080e7          	jalr	-616(ra) # f26 <putc>
    1196:	8b4a                	mv	s6,s2
      state = 0;
    1198:	4981                	li	s3,0
    119a:	bd65                	j	1052 <vprintf+0x60>
        putc(fd, c);
    119c:	85d2                	mv	a1,s4
    119e:	8556                	mv	a0,s5
    11a0:	00000097          	auipc	ra,0x0
    11a4:	d86080e7          	jalr	-634(ra) # f26 <putc>
      state = 0;
    11a8:	4981                	li	s3,0
    11aa:	b565                	j	1052 <vprintf+0x60>
        s = va_arg(ap, char*);
    11ac:	8b4e                	mv	s6,s3
      state = 0;
    11ae:	4981                	li	s3,0
    11b0:	b54d                	j	1052 <vprintf+0x60>
    }
  }
}
    11b2:	70e6                	ld	ra,120(sp)
    11b4:	7446                	ld	s0,112(sp)
    11b6:	74a6                	ld	s1,104(sp)
    11b8:	7906                	ld	s2,96(sp)
    11ba:	69e6                	ld	s3,88(sp)
    11bc:	6a46                	ld	s4,80(sp)
    11be:	6aa6                	ld	s5,72(sp)
    11c0:	6b06                	ld	s6,64(sp)
    11c2:	7be2                	ld	s7,56(sp)
    11c4:	7c42                	ld	s8,48(sp)
    11c6:	7ca2                	ld	s9,40(sp)
    11c8:	7d02                	ld	s10,32(sp)
    11ca:	6de2                	ld	s11,24(sp)
    11cc:	6109                	addi	sp,sp,128
    11ce:	8082                	ret

00000000000011d0 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    11d0:	715d                	addi	sp,sp,-80
    11d2:	ec06                	sd	ra,24(sp)
    11d4:	e822                	sd	s0,16(sp)
    11d6:	1000                	addi	s0,sp,32
    11d8:	e010                	sd	a2,0(s0)
    11da:	e414                	sd	a3,8(s0)
    11dc:	e818                	sd	a4,16(s0)
    11de:	ec1c                	sd	a5,24(s0)
    11e0:	03043023          	sd	a6,32(s0)
    11e4:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    11e8:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    11ec:	8622                	mv	a2,s0
    11ee:	00000097          	auipc	ra,0x0
    11f2:	e04080e7          	jalr	-508(ra) # ff2 <vprintf>
}
    11f6:	60e2                	ld	ra,24(sp)
    11f8:	6442                	ld	s0,16(sp)
    11fa:	6161                	addi	sp,sp,80
    11fc:	8082                	ret

00000000000011fe <printf>:
...
printf(const char *fmt, ...)
{
    ...
    1206:	e40c                	sd	a1,8(s0)
    1208:	e810                	sd	a2,16(s0)
    120a:	ec14                	sd	a3,24(s0)
    120c:	f018                	sd	a4,32(s0)
    120e:	f41c                	sd	a5,40(s0)
    1210:	03043823          	sd	a6,48(s0)
    1214:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    1218:	00840613          	addi	a2,s0,8
    121c:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    1220:	85aa                	mv	a1,a0
    1222:	4505                	li	a0,1
    1224:	00000097          	auipc	ra,0x0
    1228:	dce080e7          	jalr	-562(ra) # ff2 <vprintf>
}
    122c:	60e2                	ld	ra,24(sp)
    122e:	6442                	ld	s0,16(sp)
    1230:	6125                	addi	sp,sp,96
    1232:	8082                	ret

0000000000001234 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
    123a:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    123e:	00000797          	auipc	a5,0x0
    1242:	4727b783          	ld	a5,1138(a5) # 16b0 <freep>
    1246:	a805                	j	1276 <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    1248:	4618                	lw	a4,8(a2)
    124a:	9db9                	addw	a1,a1,a4
    124c:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    1250:	6398                	ld	a4,0(a5)
    1252:	6318                	ld	a4,0(a4)
    1254:	fee53823          	sd	a4,-16(a0)
    1258:	a091                	j	129c <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    125a:	ff852703          	lw	a4,-8(a0)
    125e:	9e39                	addw	a2,a2,a4
    1260:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    1262:	ff053703          	ld	a4,-16(a0)
    1266:	e398                	sd	a4,0(a5)
    1268:	a099                	j	12ae <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    126a:	6398                	ld	a4,0(a5)
    126c:	00e7e463          	bltu	a5,a4,1274 <free+0x40>
    1270:	00e6ea63          	bltu	a3,a4,1284 <free+0x50>
{
    1274:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1276:	fed7fae3          	bgeu	a5,a3,126a <free+0x36>
    127a:	6398                	ld	a4,0(a5)
    127c:	00e6e463          	bltu	a3,a4,1284 <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1280:	fee7eae3          	bltu	a5,a4,1274 <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    1284:	ff852583          	lw	a1,-8(a0)
    1288:	6390                	ld	a2,0(a5)
    128a:	02059713          	slli	a4,a1,0x20
    128e:	9301                	srli	a4,a4,0x20
    1290:	0712                	slli	a4,a4,0x4
    1292:	9736                	add	a4,a4,a3
    1294:	fae60ae3          	beq	a2,a4,1248 <free+0x14>
    bp->s.ptr = p->s.ptr;
    1298:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    129c:	4790                	lw	a2,8(a5)
    129e:	02061713          	slli	a4,a2,0x20
    12a2:	9301                	srli	a4,a4,0x20
    12a4:	0712                	slli	a4,a4,0x4
    12a6:	973e                	add	a4,a4,a5
    12a8:	fae689e3          	beq	a3,a4,125a <free+0x26>
  } else
    p->s.ptr = bp;
    12ac:	e394                	sd	a3,0(a5)
  freep = p;
    12ae:	00000717          	auipc	a4,0x0
    12b2:	40f73123          	sd	a5,1026(a4) # 16b0 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    12e4:	3d053503          	ld	a0,976(a0) # 16b0 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    130c:	3a890913          	addi	s2,s2,936 # 16b0 <freep>
  if(p == (char*)-1)
    1310:	5afd                	li	s5,-1
    1312:	a88d                	j	1384 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    1314:	00000797          	auipc	a5,0x0
    1318:	78c78793          	addi	a5,a5,1932 # 1aa0 <base>
    131c:	00000717          	auipc	a4,0x0
    1320:	38f73a23          	sd	a5,916(a4) # 16b0 <freep>
    ...
    132a:	b7e1                	j	12f2 <malloc+0x36>
      if(p->s.size == nunits)
    132c:	02e48b63          	beq	s1,a4,1362 <malloc+0xa6>
        p->s.size -= nunits;
    1330:	4137073b          	subw	a4,a4,s3
    1334:	c798                	sw	a4,8(a5)
        p += p->s.size;
    1336:	1702                	slli	a4,a4,0x20
    1338:	9301                	srli	a4,a4,0x20
    133a:	0712                	slli	a4,a4,0x4
    133c:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    133e:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    1342:	00000717          	auipc	a4,0x0
    1346:	36a73723          	sd	a0,878(a4) # 16b0 <freep>
      return (void*)(p + 1);
    134a:	01078513          	addi	a0,a5,16
      if((p = morecore(nunits)) == 0)
        return 0;
  }
}
    134e:	70e2                	ld	ra,56(sp)
    1350:	7442                	ld	s0,48(sp)
    1352:	74a2                	ld	s1,40(sp)
    1354:	7902                	ld	s2,32(sp)
    1356:	69e2                	ld	s3,24(sp)
    1358:	6a42                	ld	s4,16(sp)
    135a:	6aa2                	ld	s5,8(sp)
    135c:	6b02                	ld	s6,0(sp)
    135e:	6121                	addi	sp,sp,64
    1360:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    1362:	6398                	ld	a4,0(a5)
    1364:	e118                	sd	a4,0(a0)
    1366:	bff1                	j	1342 <malloc+0x86>
  hp->s.size = nu;
    1368:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    136c:	0541                	addi	a0,a0,16
    136e:	00000097          	auipc	ra,0x0
    1372:	ec6080e7          	jalr	-314(ra) # 1234 <free>
  return freep;
    1376:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    137a:	d971                	beqz	a0,134e <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    137c:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    137e:	4798                	lw	a4,8(a5)
    1380:	fa9776e3          	bgeu	a4,s1,132c <malloc+0x70>
    if(p == freep)
    1384:	00093703          	ld	a4,0(s2)
    1388:	853e                	mv	a0,a5
    138a:	fef719e3          	bne	a4,a5,137c <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    138e:	8552                	mv	a0,s4
    1390:	00000097          	auipc	ra,0x0
    1394:	b5e080e7          	jalr	-1186(ra) # eee <sbrk>
  if(p == (char*)-1)
    1398:	fd5518e3          	bne	a0,s5,1368 <malloc+0xac>
        return 0;
    139c:	4501                	li	a0,0
    139e:	bf45                	j	134e <malloc+0x92>
