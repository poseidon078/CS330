...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     3fe:	07698993          	addi	s3,s3,118 # 1470 <whitespace>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     462:	01298993          	addi	s3,s3,18 # 1470 <whitespace>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     4cc:	fa898993          	addi	s3,s3,-88 # 1470 <whitespace>
     4d0:	00001a97          	auipc	s5,0x1
     4d4:	f98a8a93          	addi	s5,s5,-104 # 1468 <symbols>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     536:	f3e98993          	addi	s3,s3,-194 # 1470 <whitespace>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5a6:	dceb8b93          	addi	s7,s7,-562 # 1370 <malloc+0x150>
  ...
  while(peek(ps, es, "<>")){
     ...
     5b8:	d9c50513          	addi	a0,a0,-612 # 1350 <malloc+0x130>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a0:	cdc60613          	addi	a2,a2,-804 # 1378 <malloc+0x158>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d0:	cccb0b13          	addi	s6,s6,-820 # 1398 <malloc+0x178>
  ...
  return ret;
     ...
     70a:	c7a50513          	addi	a0,a0,-902 # 1380 <malloc+0x160>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76c:	c2050513          	addi	a0,a0,-992 # 1388 <malloc+0x168>
...
0000000000000786 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7a6:	bfe60613          	addi	a2,a2,-1026 # 13a0 <malloc+0x180>
     7aa:	85ce                	mv	a1,s3
     7ac:	854a                	mv	a0,s2
...
00000000000007f4 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     816:	b96a0a13          	addi	s4,s4,-1130 # 13a8 <malloc+0x188>
     81a:	8652                	mv	a2,s4
     81c:	85ce                	mv	a1,s3
     81e:	854a                	mv	a0,s2
  ...
  if(peek(ps, es, ";")){
     ...
     84c:	b6860613          	addi	a2,a2,-1176 # 13b0 <malloc+0x190>
     850:	85ce                	mv	a1,s3
     852:	854a                	mv	a0,s2
...
000000000000089c <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b2:	aca60613          	addi	a2,a2,-1334 # 1378 <malloc+0x158>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e2:	aea60613          	addi	a2,a2,-1302 # 13c8 <malloc+0x1a8>
     8e6:	85ca                	mv	a1,s2
     8e8:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     924:	a9850513          	addi	a0,a0,-1384 # 13b8 <malloc+0x198>
     928:	fffff097          	auipc	ra,0xfffff
     92c:	72c080e7          	jalr	1836(ra) # 54 <panic>
    panic("syntax - missing )");
     930:	00001517          	auipc	a0,0x1
     934:	aa050513          	addi	a0,a0,-1376 # 13d0 <malloc+0x1b0>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     960:	ad470713          	addi	a4,a4,-1324 # 1430 <malloc+0x210>
...
00000000000009d8 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a0c:	9e060613          	addi	a2,a2,-1568 # 13e8 <malloc+0x1c8>
     a10:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a42:	9b258593          	addi	a1,a1,-1614 # 13f0 <malloc+0x1d0>
     a46:	4509                	li	a0,2
     a48:	00000097          	auipc	ra,0x0
     a4c:	6ec080e7          	jalr	1772(ra) # 1134 <fprintf>
    panic("syntax");
     a50:	00001517          	auipc	a0,0x1
     a54:	93050513          	addi	a0,a0,-1744 # 1380 <malloc+0x160>
...
0000000000000a60 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a76:	98e48493          	addi	s1,s1,-1650 # 1400 <malloc+0x1e0>
     a7a:	4589                	li	a1,2
     a7c:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     a9c:	9e848493          	addi	s1,s1,-1560 # 1480 <buf.1141>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa0:	06300913          	li	s2,99
     aa4:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     aa8:	00001a17          	auipc	s4,0x1
     aac:	9dba0a13          	addi	s4,s4,-1573 # 1483 <buf.1141+0x3>
        fprintf(2, "cannot cd %s\n", buf+3);
     ab0:	00001a97          	auipc	s5,0x1
     ab4:	958a8a93          	addi	s5,s5,-1704 # 1408 <malloc+0x1e8>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b2c:	60c080e7          	jalr	1548(ra) # 1134 <fprintf>
     b30:	bf79                	j	ace <main+0x6e>
      runcmd(parsecmd(buf));
     b32:	00001517          	auipc	a0,0x1
     b36:	94e50513          	addi	a0,a0,-1714 # 1480 <buf.1141>
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     e96:	4605                	li	a2,1
     e98:	fef40593          	addi	a1,s0,-17
     e9c:	00000097          	auipc	ra,0x0
     ea0:	f4e080e7          	jalr	-178(ra) # dea <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
     ...
     ebe:	0805c863          	bltz	a1,f4e <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     ed2:	58250513          	addi	a0,a0,1410 # 1450 <digits>
     ed6:	883a                	mv	a6,a4
     ed8:	2705                	addiw	a4,a4,1
  ...
  if(neg)
     efa:	00088b63          	beqz	a7,f10 <printint+0x64>
    buf[i++] = '-';
     efe:	fd040793          	addi	a5,s0,-48
  ...
  while(--i >= 0)
     f10:	02e05863          	blez	a4,f40 <printint+0x94>
    ...
    putc(fd, buf[i]);
     ...
     f36:	f58080e7          	jalr	-168(ra) # e8a <putc>
  while(--i >= 0)
     f3a:	197d                	addi	s2,s2,-1
     f3c:	ff3918e3          	bne	s2,s3,f2c <printint+0x80>
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
     ...
     f86:	02500a13          	li	s4,37
      if(c == 'd'){
     f8a:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
     f8e:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
     f92:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
     f96:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     f9a:	00000b97          	auipc	s7,0x0
     f9e:	4b6b8b93          	addi	s7,s7,1206 # 1450 <digits>
     fa2:	a839                	j	fc0 <vprintf+0x6a>
        putc(fd, c);
     fa4:	85ca                	mv	a1,s2
     fa6:	8556                	mv	a0,s5
     fa8:	00000097          	auipc	ra,0x0
     fac:	ee2080e7          	jalr	-286(ra) # e8a <putc>
     fb0:	a019                	j	fb6 <vprintf+0x60>
    } else if(state == '%'){
     fb2:	01498f63          	beq	s3,s4,fd0 <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     fc4:	fe0997e3          	bnez	s3,fb2 <vprintf+0x5c>
      if(c == '%'){
     fc8:	fd479ee3          	bne	a5,s4,fa4 <vprintf+0x4e>
        state = '%';
     fcc:	89be                	mv	s3,a5
     fce:	b7e5                	j	fb6 <vprintf+0x60>
      if(c == 'd'){
     fd0:	05878063          	beq	a5,s8,1010 <vprintf+0xba>
      } else if(c == 'l') {
     fd4:	05978c63          	beq	a5,s9,102c <vprintf+0xd6>
      } else if(c == 'x') {
     fd8:	07a78863          	beq	a5,s10,1048 <vprintf+0xf2>
      } else if(c == 'p') {
     fdc:	09b78463          	beq	a5,s11,1064 <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
     fe0:	07300713          	li	a4,115
     fe4:	0ce78663          	beq	a5,a4,10b0 <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
     ...
     fec:	0ee78e63          	beq	a5,a4,10e8 <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
     ff0:	11478863          	beq	a5,s4,1100 <vprintf+0x1aa>
        putc(fd, c);
      } else {
     ...
     ffc:	e92080e7          	jalr	-366(ra) # e8a <putc>
        putc(fd, c);
    1000:	85ca                	mv	a1,s2
    1002:	8556                	mv	a0,s5
    1004:	00000097          	auipc	ra,0x0
    1008:	e86080e7          	jalr	-378(ra) # e8a <putc>
      }
      state = 0;
    100c:	4981                	li	s3,0
    ...
    1022:	e8e080e7          	jalr	-370(ra) # eac <printint>
    1026:	8b4a                	mv	s6,s2
      state = 0;
    1028:	4981                	li	s3,0
    ...
    103e:	e72080e7          	jalr	-398(ra) # eac <printint>
    1042:	8b4a                	mv	s6,s2
      state = 0;
    1044:	4981                	li	s3,0
    ...
    105a:	e56080e7          	jalr	-426(ra) # eac <printint>
    105e:	8b4a                	mv	s6,s2
      state = 0;
    1060:	4981                	li	s3,0
    1062:	bf91                	j	fb6 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    1064:	008b0793          	addi	a5,s6,8
    1068:	f8f43423          	sd	a5,-120(s0)
    106c:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    1070:	03000593          	li	a1,48
    1074:	8556                	mv	a0,s5
    1076:	00000097          	auipc	ra,0x0
    107a:	e14080e7          	jalr	-492(ra) # e8a <putc>
  putc(fd, 'x');
    107e:	85ea                	mv	a1,s10
    1080:	8556                	mv	a0,s5
    1082:	00000097          	auipc	ra,0x0
    1086:	e08080e7          	jalr	-504(ra) # e8a <putc>
    108a:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    ...
    109c:	df2080e7          	jalr	-526(ra) # e8a <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    10a0:	0992                	slli	s3,s3,0x4
    10a2:	397d                	addiw	s2,s2,-1
    10a4:	fe0914e3          	bnez	s2,108c <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    10a8:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    10ac:	4981                	li	s3,0
    10ae:	b721                	j	fb6 <vprintf+0x60>
        s = va_arg(ap, char*);
    10b0:	008b0993          	addi	s3,s6,8
    10b4:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    10b8:	02090163          	beqz	s2,10da <vprintf+0x184>
        while(*s != 0){
    10bc:	00094583          	lbu	a1,0(s2)
    10c0:	c9a1                	beqz	a1,1110 <vprintf+0x1ba>
          putc(fd, *s);
    10c2:	8556                	mv	a0,s5
    10c4:	00000097          	auipc	ra,0x0
    10c8:	dc6080e7          	jalr	-570(ra) # e8a <putc>
          s++;
    10cc:	0905                	addi	s2,s2,1
        while(*s != 0){
    10ce:	00094583          	lbu	a1,0(s2)
    10d2:	f9e5                	bnez	a1,10c2 <vprintf+0x16c>
        s = va_arg(ap, char*);
    10d4:	8b4e                	mv	s6,s3
      state = 0;
    10d6:	4981                	li	s3,0
    10d8:	bdf9                	j	fb6 <vprintf+0x60>
          s = "(null)";
    10da:	00000917          	auipc	s2,0x0
    10de:	36e90913          	addi	s2,s2,878 # 1448 <malloc+0x228>
        while(*s != 0){
    10e2:	02800593          	li	a1,40
    10e6:	bff1                	j	10c2 <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    10e8:	008b0913          	addi	s2,s6,8
    10ec:	000b4583          	lbu	a1,0(s6)
    10f0:	8556                	mv	a0,s5
    10f2:	00000097          	auipc	ra,0x0
    10f6:	d98080e7          	jalr	-616(ra) # e8a <putc>
    10fa:	8b4a                	mv	s6,s2
      state = 0;
    10fc:	4981                	li	s3,0
    10fe:	bd65                	j	fb6 <vprintf+0x60>
        putc(fd, c);
    1100:	85d2                	mv	a1,s4
    1102:	8556                	mv	a0,s5
    1104:	00000097          	auipc	ra,0x0
    1108:	d86080e7          	jalr	-634(ra) # e8a <putc>
      state = 0;
    110c:	4981                	li	s3,0
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    11a6:	2d67b783          	ld	a5,726(a5) # 1478 <freep>
    11aa:	a805                	j	11da <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    11ac:	4618                	lw	a4,8(a2)
    11ae:	9db9                	addw	a1,a1,a4
    11b0:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    11b4:	6398                	ld	a4,0(a5)
    11b6:	6318                	ld	a4,0(a4)
    11b8:	fee53823          	sd	a4,-16(a0)
    11bc:	a091                	j	1200 <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    11be:	ff852703          	lw	a4,-8(a0)
    11c2:	9e39                	addw	a2,a2,a4
    11c4:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    11c6:	ff053703          	ld	a4,-16(a0)
    11ca:	e398                	sd	a4,0(a5)
    11cc:	a099                	j	1212 <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    11ce:	6398                	ld	a4,0(a5)
    11d0:	00e7e463          	bltu	a5,a4,11d8 <free+0x40>
    11d4:	00e6ea63          	bltu	a3,a4,11e8 <free+0x50>
{
    11d8:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    11da:	fed7fae3          	bgeu	a5,a3,11ce <free+0x36>
    11de:	6398                	ld	a4,0(a5)
    11e0:	00e6e463          	bltu	a3,a4,11e8 <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    11e4:	fee7eae3          	bltu	a5,a4,11d8 <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    11e8:	ff852583          	lw	a1,-8(a0)
    11ec:	6390                	ld	a2,0(a5)
    11ee:	02059713          	slli	a4,a1,0x20
    11f2:	9301                	srli	a4,a4,0x20
    11f4:	0712                	slli	a4,a4,0x4
    11f6:	9736                	add	a4,a4,a3
    11f8:	fae60ae3          	beq	a2,a4,11ac <free+0x14>
    bp->s.ptr = p->s.ptr;
    11fc:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    1200:	4790                	lw	a2,8(a5)
    1202:	02061713          	slli	a4,a2,0x20
    1206:	9301                	srli	a4,a4,0x20
    1208:	0712                	slli	a4,a4,0x4
    120a:	973e                	add	a4,a4,a5
    120c:	fae689e3          	beq	a3,a4,11be <free+0x26>
  } else
    p->s.ptr = bp;
    1210:	e394                	sd	a3,0(a5)
  freep = p;
    1212:	00000717          	auipc	a4,0x0
    1216:	26f73323          	sd	a5,614(a4) # 1478 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1248:	23453503          	ld	a0,564(a0) # 1478 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1270:	20c90913          	addi	s2,s2,524 # 1478 <freep>
  if(p == (char*)-1)
    1274:	5afd                	li	s5,-1
    1276:	a88d                	j	12e8 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    1278:	00000797          	auipc	a5,0x0
    127c:	27078793          	addi	a5,a5,624 # 14e8 <base>
    1280:	00000717          	auipc	a4,0x0
    1284:	1ef73c23          	sd	a5,504(a4) # 1478 <freep>
    ...
    128e:	b7e1                	j	1256 <malloc+0x36>
      if(p->s.size == nunits)
    1290:	02e48b63          	beq	s1,a4,12c6 <malloc+0xa6>
        p->s.size -= nunits;
    1294:	4137073b          	subw	a4,a4,s3
    1298:	c798                	sw	a4,8(a5)
        p += p->s.size;
    129a:	1702                	slli	a4,a4,0x20
    ...
    12aa:	1ca73923          	sd	a0,466(a4) # 1478 <freep>
      return (void*)(p + 1);
    ...
    12ca:	bff1                	j	12a6 <malloc+0x86>
  hp->s.size = nu;
    12cc:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    12d0:	0541                	addi	a0,a0,16
    12d2:	00000097          	auipc	ra,0x0
    12d6:	ec6080e7          	jalr	-314(ra) # 1198 <free>
  return freep;
    12da:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    12de:	d971                	beqz	a0,12b2 <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    12e0:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    12e2:	4798                	lw	a4,8(a5)
    12e4:	fa9776e3          	bgeu	a4,s1,1290 <malloc+0x70>
    if(p == freep)
    12e8:	00093703          	ld	a4,0(s2)
    12ec:	853e                	mv	a0,a5
    12ee:	fef719e3          	bne	a4,a5,12e0 <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    12f2:	8552                	mv	a0,s4
    12f4:	00000097          	auipc	ra,0x0
    12f8:	b5e080e7          	jalr	-1186(ra) # e52 <sbrk>
  if(p == (char*)-1)
    12fc:	fd5518e3          	bne	a0,s5,12cc <malloc+0xac>
        return 0;
    1300:	4501                	li	a0,0
    1302:	bf45                	j	12b2 <malloc+0x92>
